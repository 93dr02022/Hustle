...
} elseif ($_instance->childHasBeenRendered('l45779392-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l45779392-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l45779392-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l45779392-0');
} else {
    $response = \Livewire\Livewire::mount('main.partials.languages');
    $html = $response->html();
    $_instance->logRenderedChild('l45779392-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l45779392-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l45779392-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l45779392-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l45779392-1');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('l45779392-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l45779392-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l45779392-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l45779392-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l45779392-2');
} else {
    $response = \Livewire\Livewire::mount('main.partials.cart');
    $html = $response->html();
    $_instance->logRenderedChild('l45779392-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/resources/views/livewire/main/includes/header.blade.php ENDPATH**/ ?>