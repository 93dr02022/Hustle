...
} elseif ($_instance->childHasBeenRendered('l565107365-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l565107365-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l565107365-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l565107365-1');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.overview');
    $html = $response->html();
    $_instance->logRenderedChild('l565107365-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l565107365-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l565107365-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l565107365-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l565107365-2');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.pricing');
    $html = $response->html();
    $_instance->logRenderedChild('l565107365-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l565107365-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l565107365-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l565107365-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l565107365-3');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.requirements');
    $html = $response->html();
    $_instance->logRenderedChild('l565107365-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l565107365-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l565107365-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l565107365-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l565107365-4');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.gallery');
    $html = $response->html();
    $_instance->logRenderedChild('l565107365-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\artisan\riverr\resources\views/livewire/main/create/create.blade.php ENDPATH**/ ?>