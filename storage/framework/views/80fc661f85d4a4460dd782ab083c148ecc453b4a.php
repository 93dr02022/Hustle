                    ...
                    <div class="intro-x">
                        <div class="bg-white rounded-lg px-5 py-3 mb-3 flex items-center zoom-in dark:bg-zinc-900">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden ring-gray-100 ring-1 dark:ring-transparent">
                                <img class="lazy" alt="<?php echo e($city->country_name); ?>" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('img/flags', strtolower("$city->country_code.svg"))); ?>">
                            </div>
                            <div class="ltr:ml-4 ltr:mr-auto rtl:mr-4 rtl:ml-auto">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script defer src="<?php echo e(url('js/plugins/jvectormap/jquery-jvectormap-2.0.5.min.js')); ?>"></script>
    <script defer src="<?php echo e(url('js/plugins/jvectormap/jquery-jvectormap-world-mill.js')); ?>"></script>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\artisan\riverr\resources\views/livewire/main/seller/gigs/options/analytics.blade.php ENDPATH**/ ?>