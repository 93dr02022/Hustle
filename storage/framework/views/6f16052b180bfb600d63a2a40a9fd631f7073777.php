                        ...
                        <div class="px-4 py-8">
                            ...
                            <a href="<?php echo e(url('profile', $seller->username)); ?>" target="_blank" class="mt-4 text-gray-900 dark:text-gray-200 text-sm font-bold tracking-wider flex items-center justify-center">
                                ...
                                <?php if($seller->status === 'verified'): ?>
                                    <img data-tooltip-target="tooltip-account-verified-<?php echo e($seller->id); ?>" class="ltr:ml-0.5 rtl:mr-0.5 h-4 w-4 -mt-0.5" src="<?php echo e(url('img/auth/verified-badge.svg')); ?>" alt="<?php echo e(__('messages.t_account_verified')); ?>">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\artisan\riverr\resources\views/livewire/main/home/home.blade.php ENDPATH**/ ?>