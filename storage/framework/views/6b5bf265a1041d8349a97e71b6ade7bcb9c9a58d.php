                                    ...
                                    <div class="ltr:ml-3 rtl:mr-3">
                                        <div class="text-gray-500 hover:text-gray-900 dark:text-gray-200 dark:hover:text-gray-100 flex items-center">
                                            ...
                                            <?php if($gig->owner->status === 'verified'): ?>
                                                <img data-tooltip-target="tooltip-account-verified-<?php echo e($gig->uid); ?>" class="ltr:ml-0.5 rtl:mr-0.5 h-4 w-4 -mt-0.5" src="<?php echo e(url('img/auth/verified-badge.svg')); ?>" alt="<?php echo e(__('messages.t_account_verified')); ?>">
                                                ...
                                                <div class="ltr:ml-4 rtl:mr-4 group">
                                                    <a href="<?php echo e(url('profile', $review->user->username)); ?>" target="_blank" class="text-sm font-bold text-gray-900 dark:text-gray-200 flex items-center group-hover:text-primary-600">
                                                        ...
                                                        <?php if($review->user->status === 'verified'): ?>
                                                            <img data-tooltip-target="account-verified-badge-<?php echo e($review->uid); ?>" class="ltr:ml-0.5 rtl:mr-0.5 h-4 w-4 -mt-0.5" src="<?php echo e(url('img/auth/verified-badge.svg')); ?>" alt="<?php echo e(__('messages.t_account_verified')); ?>">
...
<?php $__env->stopPush(); ?><?php /**PATH C:\artisan\riverr\resources\views/livewire/main/service/service.blade.php ENDPATH**/ ?>