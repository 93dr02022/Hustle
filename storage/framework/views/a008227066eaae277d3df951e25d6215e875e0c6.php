...
<html lang="<?php echo e(app()->getLocale()); ?>" dir="<?php echo e(config()->get('direction')); ?>">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(mix('css/mdi.css')); ?>">
...
} elseif ($_instance->childHasBeenRendered('cy3wZoj')) {
    $componentId = $_instance->getRenderedChildComponentId('cy3wZoj');
    $componentTag = $_instance->getRenderedChildComponentTagName('cy3wZoj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cy3wZoj');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('cy3wZoj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('52fwJuJ')) {
    $componentId = $_instance->getRenderedChildComponentId('52fwJuJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('52fwJuJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('52fwJuJ');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('52fwJuJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\artisan\riverr\resources\views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>