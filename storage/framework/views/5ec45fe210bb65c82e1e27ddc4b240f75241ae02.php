                        ...
                        <div class="flex flex-col text-center mt-3 mb-4">
                            <span class="text-md font-extrabold text-gray-800 dark:text-gray-100 flex items-center justify-center">
                                ...
                                <?php if($user->status === 'verified'): ?>
                                    <img data-tooltip-target="tooltip-account-verified-<?php echo e($user->id); ?>" class="ltr:ml-0.5 rtl:mr-0.5 h-4 w-4 -mt-0.5" src="<?php echo e(url('img/auth/verified-badge.svg')); ?>" alt="<?php echo e(__('messages.t_account_verified')); ?>">
                        ...
                        <?php if($user->country): ?>
                            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 dark:text-gray-200 sm:mt-0 sm:col-span-2 flex items-center">
                                    <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('img/flags/rounded/'. strtolower($user->country?->code) .'.svg')); ?>" alt="<?php echo e($user->country?->name); ?>" class="lazy h-5 w-5 ltr:mr-2 rtl:ml-2">  
...
<?php $__env->stopPush(); ?><?php /**PATH C:\artisan\riverr\resources\views/livewire/main/profile/profile.blade.php ENDPATH**/ ?>