                        ...
                        <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 md:rtl:space-x-reverse sm:mb-0">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <a href="<?php echo e(url('seller/home')); ?>" class="text-sm font-medium text-gray-700 ltr:ml-1 rtl:mr-1 hover:text-primary-600 md:ltr:ml-2 md:rtl:mr-2 dark:text-zinc-300 dark:hover:text-white">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        function SellerDashboardCreateQuote() {
            return {
                errors: <?php echo json_encode($errors, 15, 512) ?>,
                successful: false,
                form: {
                    first_name: "",
                    last_name: "",
                ...
                async createQuotation() {
                    let res = await window.livewire.find('<?php echo e($_instance->id); ?>').create(this.form);
                    if (res?.errors) {
