<div>
    ...
    <div class="text-sm font-medium text-zinc-600 dark:text-gray-100 flex items-center justify-center !mt-0">
        ...
        <div id="selected-contact-verification" style="display: none">
            <img data-tooltip-target="tooltip-account-verified" class="ltr:ml-0.5 rtl:mr-0.5 h-4.5 w-4.5 -mt-0.5" src="<?php echo e(url('img/auth/verified-badge.svg')); ?>" alt="<?php echo e(__('messages.t_account_verified')); ?>">
...
<?php /**PATH C:\artisan\riverr\resources\views/vendor/Chatify/layouts/info.blade.php ENDPATH**/ ?>