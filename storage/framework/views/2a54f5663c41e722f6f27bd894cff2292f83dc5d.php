...
} elseif ($_instance->childHasBeenRendered('E6MON87')) {
    $componentId = $_instance->getRenderedChildComponentId('E6MON87');
    $componentTag = $_instance->getRenderedChildComponentTagName('E6MON87');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('E6MON87');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('E6MON87', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('TzMyW2d')) {
    $componentId = $_instance->getRenderedChildComponentId('TzMyW2d');
    $componentTag = $_instance->getRenderedChildComponentTagName('TzMyW2d');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TzMyW2d');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('TzMyW2d', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="http://localhost:8000/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>

        
        <script defer src="<?php echo e(mix('js/app.js')); ?>"></script>

        
        <script defer src="<?php echo e(url('js/utils.js?v=1.3.1')); ?>"></script>
        <script src="<?php echo e(url('js/components.js?v=1.3.1')); ?>"></script>
...
</html><?php /**PATH /var/www/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>