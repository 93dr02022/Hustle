...
<head>
	...
	<link rel="stylesheet" href="<?php echo e(url('js/plugins/emojipanel/dist/emojipanel.css')); ?>" />
	<link rel="stylesheet" href="<?php echo e(url('js/plugins/file-icon-vectors/file-icon-vectors.min.css')); ?>" />
	<link rel='stylesheet' href="<?php echo e(url('js/plugins/nprogress/nprogress.css')); ?>" />
	<link rel="stylesheet" href="<?php echo e(url('css/chatify/style.css')); ?>" />
	<link rel="stylesheet" href="<?php echo e(url('css/chatify/'.$dark_mode.'.mode.css')); ?>" />
	...
	<script src="<?php echo e(url('js/chatify/autosize.js')); ?>"></script>
	...
	<script src="<?php echo e(url('js/plugins/twemoji/twemoji.min.js')); ?>"></script>
	<script src="<?php echo e(url('js/plugins/nprogress/nprogress.js')); ?>"></script>
	<script src="<?php echo e(url('js/plugins/emoji-mart/dist/browser.js')); ?>"></script>
	<script src="<?php echo e(url('js/plugins/momentjs/moment-with-locales.js')); ?>"></script>
	<script src="<?php echo e(url('js/plugins/momentjs/moment-timezone.min.js')); ?>"></script>
	<script src="<?php echo e(url('js/plugins/momentjs/moment-timezone-with-data-1970-2030.min.js')); ?>"></script>

</head><?php /**PATH C:\artisan\riverr\resources\views/vendor/Chatify/layouts/headLinks.blade.php ENDPATH**/ ?>