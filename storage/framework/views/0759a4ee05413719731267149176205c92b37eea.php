			...
			<div class="h-80 w-full absolute bottom-0 xl:inset-0 xl:h-full">
				<div class="h-full w-full xl:grid xl:grid-cols-2">
					<div class="h-full xl:relative xl:col-start-2">
						<img class="h-full w-full object-cover opacity-25 xl:absolute xl:inset-0 ltr:rounded-r-lg rtl:rounded-l-lg lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('img/start_selling/1.jpg')); ?>" alt="<?php echo e(__('messages.t_u_bring_the_skill_make_earn_easy')); ?>">
			...
			<?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div>
					<div class="group relative p-4 mb-5 min-h-[190px flex]">
						...
						<img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('img/start_selling/' . $seller['avatar'])); ?>" alt="<?php echo e($seller['name']); ?>" class="relative rounded-lg shadow object-cover lazy">
					</div>
						...
						<blockquote>
							...
							<footer class="flex items-center space-x-4 rtl:space-x-reverse">
								<div class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
									<img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('img/start_selling/9.jpg')); ?>" alt="<?php echo e(__('messages.t_fake_name_alex_saunders')); ?>" class="object-cover w-12 h-12 lazy">
								</div>
								<div>
			...
			<div class="border rounded-md bg-white dark:bg-zinc-800 dark:border-zinc-700 shadow-sm relative">
				...
				<div class="px-4 pt-14 pb-6 sm:px-6 sm:pb-6 relative">
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
								<img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('img/start_selling/7.jpg')); ?>" alt="<?php echo e(__('messages.t_fake_name_ricky_jones')); ?>" class="object-cover w-12 h-12 lazy">
							</div>
							<div>
								<div class="font-semibold text-primary-600 hover:text-primary-400">
			...
			<div class="border rounded-md bg-white dark:bg-zinc-800 dark:border-zinc-700 shadow-sm relative">
				...
				<div class="px-4 pt-14 pb-6 sm:px-6 sm:pb-6 relative">
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
								<img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('img/start_selling/8.jpg')); ?>" alt="<?php echo e(__('messages.t_fake_name_melissa_ross')); ?>" class="object-cover w-12 h-12 lazy">
							</div>
							<div>
								<div class="font-semibold text-primary-600 hover:text-primary-400">
...
</div><?php /**PATH C:\artisan\riverr\resources\views/livewire/main/become/seller.blade.php ENDPATH**/ ?>