...
<script>
	...
	window.chatify = {
		...
		notification_sound       : "<?php echo e(url('js/chatify/sounds/new-message-sound.mp3')); ?>"
	};
...
<script src="<?php echo e(url('js/chatify/utils.js')); ?>"></script>
<script src="<?php echo e(url('js/chatify/code.js')); ?>"></script>
<?php /**PATH C:\artisan\riverr\resources\views/vendor/Chatify/layouts/footerLinks.blade.php ENDPATH**/ ?>