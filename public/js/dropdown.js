...
function LogicDropdown() {
  ...
  function makePopper(triggerEl, targetEl) {
    ...
    return (0,_popperjs_core__WEBPACK_IMPORTED_MODULE_0__.createPopper)(triggerEl, targetEl, {
      ...
      modifiers: [{
        name: "offset",
        options: {
          offset: [0, Number((_triggerEl$dataset$of = triggerEl === null || triggerEl === void 0 ? void 0 : (_triggerEl$dataset = triggerEl.dataset) === null || _triggerEl$dataset === void 0 ? void 0 : _triggerEl$dataset.offset) !== null && _triggerEl$dataset$of !== void 0 ? _triggerEl$dataset$of : 7)]
        }
      }]
    });
  }
  ...
  function toggle(e) {
    if (e.target.dataset.lcToggle == "dropdown" && e.target.classList.contains("active")) {
      ...
      if (e.target.dataset.lcToggle == "dropdown" || e.target.parentElement.dataset.lcToggle == "dropdown") {
