      ...
      <div class="w-full relative">
         ...
         <div class="bg-white rounded-md mt-4 shadow px-5 py-6 md:px-12 md:py-8 mb-8 dark:bg-zinc-800 dark:shadow-none">
            ...
            <div class="text-center mb-16">
               <div class="h-24 w-24 bg-gray-100 dark:bg-zinc-700/40 rounded-full flex items-center justify-center mx-auto mb-2">
                  <svg class="w-10 h-10 text-gray-400 dark:text-zinc-300" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                     <path
            ...
            <div class="grid grid-cols-12 gap-y-8 gap-x-5" id="section-main-details">
               ...
               <div class="col-span-12">
                  ...
                  <div class="relative rounded-md shadow-sm">
                     ...
                     <input type="text" v-model="v$.form.title.$model"
                        ...
                        class="focus:!ring-1 block w-full ltr:pr-10 ltr:pl-4 rtl:pl-10 rtl:!pr-4 py-3.5 placeholder:font-normal placeholder:text-[13px] text-sm font-medium text-zinc-800 rounded-md dark:bg-zinc-700/40 dark:border-zinc-700 dark:text-zinc-300 dark:placeholder-zinc-400"
                        :placeholder="__('t_project_title')" maxlength="100">

                     <!-- Icon -->
                     <div class="absolute inset-y-0 ltr:right-0 rtl:left-0 ltr:pr-4 rtl:pl-4 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 text-gray-400" stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"
               ...
               <div class="col-span-12">
                  ...
                  <div class="relative rounded-md shadow-sm">
                     ...
                     <!-- Input -->
                     <textarea v-model="v$.form.description.$model" rows="12"
                        :class="hasError('description') || v$.form.description.$errors.length ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'"
                        class="block w-full ltr:pr-10 ltr:pl-4 rtl:pl-10 rtl:pr-4 py-3.5 placeholder:font-normal placeholder:text-[13px] text-sm font-medium text-zinc-800 rounded-md resize-none dark:bg-zinc-700/40 dark:border-zinc-700 dark:text-zinc-300 dark:placeholder-zinc-400"
                        :placeholder="__('t_project_description')"></textarea>
         ...
         <div class="bg-white rounded-md mt-4 shadow px-5 py-6 md:px-12 md:py-8 mb-8 dark:bg-zinc-800 dark:shadow-none">
            <div class="grid grid-cols-12 gap-y-8 gap-x-5">
               ...
               <div v-if="form.salary_type === 'hourly'" class="col-span-12">
                  <div class="bg-yellow-100 text-yellow-600 rounded py-4 px-4">
                     <small class="">Minimum hiring hours is 4 hrs in which hourly rate must be up to 10,000</small>
                  </div>
               </div>
               ...
               <div class="col-span-12 md:col-span-6">
                  ...
                  <div class="relative rounded-md shadow-sm flex">
                     ...
                     <!-- Label -->
                     <span
                        class="inline-flex items-center px-3 ltr:rounded-l-md rtl:rounded-r-md border ltr:border-r-0 rtl:border-l-0 border-gray-300 bg-gray-50 text-gray-500 text-sm dark:bg-zinc-700 dark:border-zinc-700 dark:text-zinc-400"
                        v-text="__('t_min')"></span>

                     <!-- Input -->
                     <input type="text" v-model="v$.form.price_min.$model"
                        :class="hasError('price_min') || v$.form.price_min.$errors.length ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'"
                        class="block w-full ltr:pl-4 ltr:pr-12 rtl:pr-4 rtl:pl-12 py-3.5 placeholder:font-normal text-sm font-medium text-zinc-800 flex-1 min-w-0 rounded-none ltr:rounded-r-md rtl:rounded-l-md dark:bg-zinc-700/40 dark:border-zinc-700 dark:text-zinc-300 dark:placeholder-zinc-400"
                        :placeholder="__('t_price_placeholder_0_00')">
               ...
               <div class="col-span-12 md:col-span-6">
                  ...
                  <div class="relative rounded-md shadow-sm flex">
                     ...
                     <span
                        class="inline-flex items-center px-3 ltr:rounded-l-md rtl:rounded-r-md border ltr:border-r-0 rtl:border-l-0 border-gray-300 bg-gray-50 text-gray-500 text-sm dark:bg-zinc-700 dark:border-zinc-700 dark:text-zinc-400"
                        v-text="__('t_max')"></span>

                     <!-- Input -->
                     <input type="text" v-model="v$.form.price_max.$model"
                        :class="hasError('price_max') || v$.form.price_max.$errors.length ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'"
                        class="block w-full ltr:pl-4 ltr:pr-12 rtl:pr-4 rtl:pl-12 py-3.5 placeholder:font-normal text-sm font-medium text-zinc-800 flex-1 min-w-0 rounded-none ltr:rounded-r-md rtl:rounded-l-md dark:bg-zinc-700/40 dark:border-zinc-700 dark:text-zinc-300 dark:placeholder-zinc-400"
                        :placeholder="__('t_price_placeholder_0_00')">
         ...
         <div class="flex items-center justify-between">
            ...
            <!-- Post project -->
            <button v-on:click="create" :disabled="loading.button_create" :class="loading.button_create ? 'cursor-not-allowed bg-opacity-50' : ''"
               ...
               <span class="flex items-center justify-center">
                  ...
                  <template v-if="loading.button_create">
                     <svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" class="animate-spin ltr:mr-2 rtl:ml-2 w-5 h-5" xmlns="http://www.w3.org/2000/svg">
...
export default {
   ...
   validations() {
      return {
         form: {
            ...
            price_min: {
               required: helpers.withMessage(this.__('t_validator_required'), required),
               minPrice: helpers.withMessage('Minimum fixed payment is 10,000', this.minPrice)
            },
            price_max: {
               required: helpers.withMessage(this.__('t_validator_required'), required),
               minPriceMax: helpers.withMessage('Max price must be greater than min price', this.minPriceMax)
            }
         },
      }
   },
   ...
   methods: {
      minPrice(value) {
         if (this.form.salary_type == 'fixed') {
            return value >= 10000;
         }

         if (this.form.salary_type == 'hourly') {
            return value * 4 >= 10000;
         }
      ...
      minPriceMax(value) {
         return this.form.price_max > this.form.price_min
      },
