   ...
   <div class="w-full">
      ...
      <div class="w-full relative">
         ...
         <div class="flex items-center justify-between">
            ...
            <!-- Update project -->
            <button v-on:click="update" :disabled="loading.button_update" :class="loading.button_update ? 'cursor-not-allowed bg-opacity-50' : ''"
...
export default {
   ...
   props: ['_project', 'selected_skills', 'translations', 'categories', 'currency_symbol', 'plans', '_settings', 'is_recaptcha', 'recaptcha_site_key'],
   ...
   data() {
      return {
         form: {
            title: null,
            description: null,
            category: JSON.parse(this._project)?.category_id,
            salary_type: 'fixed',
            price_min: null,
            price_max: null,
            skills: JSON.parse(this.selected_skills),
            plans: [],
   ...
   mounted() {
      ...
      // this.fetchSkills(this.form.category - 1);
      this.fetchSkills(this.form.category);
