<div class="col-span-12 py-4 px-6   bg-white border border-gray-200 text-sm rounded-lg shadow-sm md:col-span-6 dark:border-zinc-700 dark:bg-zinc-800">
    <h1 class="font-bold text-">Order Timeline</h1>

    <ol class="relative border-l text-xs border-gray-200 dark:border-gray-700">
