<div class="modal-backdrop bg-gray-500 bg-opacity-75 overflow-y-auto overflow-x-hidden fixed inset-0 z-[500] h-full items-end xs:items-center translate-y-full md:translate-y-0 md:translate-x-full transition-transform duration-300"
