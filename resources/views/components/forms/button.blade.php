...
<button 
    ...
    class="{{ $block ? 'w-full' : '' }} text-[13px] font-semibold flex justify-center {{ $active }} py-4 px-8 rounded tracking-wide focus:outline-none focus:shadow-outline cursor-pointer"
    {{ $attributes }}
    >
