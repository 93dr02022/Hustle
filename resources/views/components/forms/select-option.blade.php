...
<div>
    ...
    <div class="mt-2 relative">
        ...
        {{-- Input --}}
        <select type="{{ $type }}" @if ($placeholder) placeholder="{{ htmlspecialchars_decode($placeholder) }}" @endif
            @if ($model) wire:model.defer="{{ $model }}" @endif id="text-input-component-id-{{ $model }}"
