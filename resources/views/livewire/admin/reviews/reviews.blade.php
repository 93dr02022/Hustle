                        ...
                        <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40"
                            ...
                            <td class="ltr:pl-4 rtl:pr-4">
                                <a href="{{ url('profile', $review->user->username) }}" target="_blank"
                                    ...
                                    <div class="ltr:pl-4 rtl:pr-4">
                                        ...
                                        <p class="text-[11px] leading-3 text-gray-600 pt-2">{{ $review->user->email }}
                                        </p>
                                    </div>
                                </a>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="relative inline-block text-left">
                                    <div>
                                        <button data-dropdown-toggle="table-options-dropdown-{{ $review->id }}"
                                            type="button"
                                    ...
                                    <div id="table-options-dropdown-{{ $review->id }}"
                                        ...
                                        <div class="py-1" role="none">
                                            ...
                                            {{-- Delete --}}
                                            <button
                                                x-on:click="confirm('{{ __('messages.t_are_u_sure_u_want_to_delete_this') }}') ? $wire.delete('{{ $review->id }}') : ''"
                                                wire:loading.attr="disabled"
                                                wire:target="delete('{{ $review->id }}')" type="button"
