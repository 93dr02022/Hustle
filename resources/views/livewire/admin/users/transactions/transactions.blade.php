                    ...
                    @foreach ($transactions as $t)
                        <tr wire:key="users-transactions-{{ $t->uid }}">
                            ...
                            <td class="px-7 py-3 ltr:text-left rtl:text-right">
                                <a href="{{ url('profile', $t->user->username) }}" target="_blank"
                                    class="flex items-center">
                                    <div class="w-8 h-8">
                                        <img class="w-full h-full rounded object-cover lazy"
                                            src="{{ placeholder_img() }}" data-src="{{ src($t->user->avatar_id) }}"
                                            alt="{{ $t->user->username }}" />
                                    </div>
                            ...
                            <td class="p-3 text-center">
                                @if ($t->status === 'pending')
                                    ...
                                    <div class="space-x-4 rtl:space-x-reverse">
                                        ...
                                        <div id="tooltip-action-approve-{{ $t->id }}" role="tooltip"
                                            class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                        ...
                                        <div id="tooltip-action-reject-{{ $t->id }}" role="tooltip"
                                            class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                    ...
                                    {{-- Reject reason --}}
                                    <x-forms.modal id="modal-reject-payment-container-{{ $t->id }}"
                                        target="modal-reject-payment-button-{{ $t->id }}"
