        ...
        <div class="py-10 px-12">
            ...
            <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                ...
                <div class="col-span-12">
                    <x-forms.checkbox :label="__('messages.t_enable_hero_section_background_img')" model="enable_bg_img" />
                </div>
                ...
                <div class="col-span-12">
                    ...
                    {{-- Preview image --}}
                    @if (settings('hero')->bg_large_id)
                        <div class="mt-3">
                            <img src="{{ src(settings('hero')->bg_large_id) }}"
                ...
                <div class="col-span-12">
                    ...
                    {{-- Preview image --}}
                    @if (settings('hero')->bg_medium_id)
                        <div class="mt-3">
                            <img src="{{ src(settings('hero')->bg_medium_id) }}"
                                class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    @endif
                </div>
                ...
                <div class="col-span-12">
                    ...
                    {{-- Preview image --}}
                    @if (settings('hero')->bg_small_id)
                        <div class="mt-3">
                            <img src="{{ src(settings('hero')->bg_small_id) }}"
                                class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    @endif
                </div>
                ...
                <div class="col-span-12">
                    <x-forms.text-input :label="__('messages.t_hero_section_default_bg_color')" :placeholder="__('messages.t_enter_color_hex_color_example')" model="bg_color" icon="format-title" />
                </div>

                {{-- Hero section large screen height --}}
                <div class="col-span-12 md:col-span-6">
                    <x-forms.text-input :label="__('messages.t_large_screen_height')" :placeholder="__('messages.t_enter_value_in_pixel')" model="bg_large_height"
                        icon="align-horizontal-distribute" />
                </div>

                {{-- Hero section small screen height --}}
                <div class="col-span-12 md:col-span-6">
                    <x-forms.text-input :label="__('messages.t_small_screen_height')" :placeholder="__('messages.t_enter_value_in_pixel')" model="bg_small_height"
                        icon="align-horizontal-distribute" />
                </div>
