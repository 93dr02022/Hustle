                ...
                <thead>
                    @forelse ($reports as $r)
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16"
                            wire:key="admin-dashboard-reported-projects-{{ $r->uid }}">
                            ...
                            <td
                                ...
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    {{-- Client --}}
                                    <a href="{{ admin_url('users/details/' . $r->project->client->uid) }}"
                                        class="h-10 w-10">
                                        <img class="w-full h-full rounded-md object-cover lazy"
                                            src="{{ placeholder_img() }}"
                                            data-src="{{ src($r->project->client->avatar_id) }}"
                                            alt="{{ $r->project->client->username }}">
                                    </a>
                                    ...
                                    <div>
                                        ...
                                        {{-- Title --}}
                                        <a href="{{ url('project/' . $r->project->pid . '/' . $r->project->slug) }}"
                                            target="_blank"
                                        ...
                                        <div class="text-slate-500 text-xs whitespace-nowrap">
                                            @switch($r->project->status)
                                                ...
                                                @case('active')
                                                    <span
                                                        class="bg-emerald-100 text-emerald-700 py-1 px-2 rounded-sm inline-block  font-medium text-xs whitespace-nowrap">
                                                ...
                                                @case('pending_payment')
                                                    <span
                                                        class="bg-amber-100 text-amber-600 py-1 px-2 rounded-sm inline-block  font-medium text-xs whitespace-nowrap">
                                                ...
                                                @case('completed')
                                                    <span
                                                        class="bg-green-100 text-green-600 py-1 px-2 rounded-sm inline-block  font-medium text-xs whitespace-nowrap">
                                                ...
                                                @case('hidden')
                                                    <span
                                                        class="bg-gray-100 text-gray-600 py-1 px-2 rounded-sm inline-block  font-medium text-xs whitespace-nowrap">
                                                ...
                                                @case('rejected')
                                                    <span
                                                        class="bg-red-100 text-red-600 py-1 px-2 rounded-sm inline-block  font-medium text-xs whitespace-nowrap">
                                                ...
                                                @case('under_development')
                                                    <span
                                                        class="bg-blue-100 text-blue-600 py-1 px-2 rounded-sm inline-block  font-medium text-xs whitespace-nowrap">
                                                ...
                                                @case('pending_final_review')
                                                    <span
                                                        class="bg-fuchsia-100 text-fuchsia-600 py-1 px-2 rounded-sm inline-block  font-medium text-xs whitespace-nowrap">
                                                ...
                                                @case('incomplete')
                                                    <span
                                                        class="bg-stone-100 text-stone-600 py-1 px-2 rounded-sm inline-block  font-medium text-xs whitespace-nowrap">
                                                ...
                                                @case('closed')
                                                    <span
                                                        class="bg-rose-100 text-rose-600 py-1 px-2 rounded-sm inline-block  font-medium text-xs whitespace-nowrap">
                            ...
                            {{-- Reason --}}
                            <td
                                class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-44">
