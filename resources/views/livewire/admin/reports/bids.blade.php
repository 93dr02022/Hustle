                ...
                <thead>
                    @forelse ($reports as $r)
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16"
                            ...
                            {{-- Reason --}}
                            <td
                                class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-52">
                            ...
                            <td
                                ...
                                @if ($r->is_seen)
                                    <span
                                        class="bg-zinc-100 text-zinc-700 px-4 inline-block leading-9 h-9 rounded-3xl font-medium text-xs whitespace-nowrap">
                                        @lang('messages.t_seen')
                                    </span>
                                @else
                                    <span
                                        class="bg-blue-100 text-blue-700 px-4 inline-block leading-9 h-9 rounded-3xl font-medium text-xs whitespace-nowrap">
                                        @lang('messages.t_new')
                                    </span>
                                @endif
                            </td>
                            ...
                            <td
                                ...
                                <div class="flex items-center justify-center space-x-4 rtl:space-x-reverse">
                                    ...
                                    <div>
                                        <button type="button"
                                            data-tooltip-target="tooltip-actions-preview-{{ $r->uid }}"
                                            id="modal-preview-bid-button-{{ $r->uid }}"
                                        ...
                                        <x-forms.tooltip id="tooltip-actions-preview-{{ $r->uid }}"
                                            :text="__('messages.t_preview_bid')" />
                                    </div>

                                    {{-- Details --}}
                                    <div>
                                        <button wire:click="details('{{ $r->id }}')" type="button"
                                            data-tooltip-target="tooltip-actions-details-{{ $r->uid }}"
                                            class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
                                            <svg class="w-4 h-4" stroke="currentColor" fill="currentColor"
                                        ...
                                        <x-forms.tooltip id="tooltip-actions-details-{{ $r->uid }}"
                                    ...
                                    @if (!$r->is_seen)
                                        <div>
                                            <button wire:click="mark('{{ $r->id }}')" type="button"
                                                data-tooltip-target="tooltip-actions-mark-{{ $r->uid }}"
                                                class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
                                                <svg class="w-4 h-4" stroke="currentColor" fill="currentColor"
                                            ...
                                            <x-forms.tooltip id="tooltip-actions-mark-{{ $r->uid }}"
                                                :text="__('messages.t_mark_as_read')" />
                                        </div>
                                    @endif
                        ...
                        {{-- Preview Modal --}}
                        <x-forms.modal id="modal-preview-bid-container-{{ $r->uid }}"
                            target="modal-preview-bid-button-{{ $r->uid }}"
                            uid="modal_preview_bid_{{ $r->uid }}" placement="center-center" size="max-w-2xl">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="mb-8">
                                            ...
                                            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                                ...
                                                {{-- Avatar --}}
                                                <a href="{{ url('profile', $r->bid->user->username) }}"
                                                    class="block">
                                                    <img class="rounded-full h-12 w-12 object-cover object-center lazy"
                                                        src="{{ placeholder_img() }}"
                                                        data-src="{{ src($r->bid->user->avatar_id) }}"
                                                        alt="{{ $r->bid->user->username }}">
                                                </a>
                                                    ...
                                                    <div
                                                        ...
                                                        @if ($r->bid->user->country)
                                                            <p class="flex items-center space-x-1 rtl:space-x-reverse">
                                                                <img class="h-4 ltr:pr-0.5 rtl:pl-0.5 -mt-0.5 lazy"
                                                                    src="{{ placeholder_img() }}"
                                                                    data-src="{{ countryFlag($r->bid->user->country->code) }}"
                                                                    alt="{{ $r->bid->user->country->name }}">
                                                        ...
                                                        <p
                                                            ...
                                                            <svg aria-hidden="true"
                                                                class="w-4 h-4 {{ $r->bid->user->rating() == 0 ? 'text-gray-400' : 'text-amber-500' }} -mt-0.5"
