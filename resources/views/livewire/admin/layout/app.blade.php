...
<html lang="{{ app()->getLocale() }}" dir="{{ config()->get('direction') }}">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ mix('css/mdi.css') }}">
    ...
    <body class="antialiased bg-[#f8fafc] text-gray-600 min-h-full flex flex-col application application-ltr overflow-x-hidden overflow-y-hidden scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-zinc-900 dark:scrollbar-track-zinc-600" x-data="window.QCwuToAKMICZSdT">
        ...
        <div id="notifications-drawer" class="fixed top-0 right-0 z-40 h-screen px-6 py-4 overflow-y-auto transition-transform translate-x-full bg-white w-96 dark:bg-gray-800 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-zinc-900 dark:scrollbar-track-zinc-600" tabindex="-1" aria-labelledby="notifications-drawer-label">
            <div class="h-screen">
                ...
                <div class="flex items-center justify-between">
                    <p tabindex="0" class="text-base font-bold leading-6 focus:outline-none text-zinc-800">
                        @lang('messages.t_notifications')
                    </p>
                    <button role="button" aria-label="close modal" class="flex items-center justify-center w-8 h-8 rounded-full cursor-pointer focus:outline-none focus:ring-0 hover:bg-slate-100" data-drawer-hide="notifications-drawer" aria-controls="notifications-drawer">
                ...
                <div class="py-10 space-y-6">
                    ...
                    @if ($notifications['count_pending_users'])
                        <a href="{{ admin_url('users') }}" class="flex items-center w-full p-3 text-red-700 bg-red-100 rounded hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border border-red-200 rounded-full focus:outline-none">
                            ...
                            {{-- Notification --}}
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
        
                                {{-- Message --}}
                                <p class="text-sm leading-none focus:outline-none">
                                    @lang('messages.t_pending_users')
                                </p>
        
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold bg-red-200 border border-red-300 rounded-full focus:outline-none">
                    ...
                    @if ($notifications['count_pending_deposit_transactions'])
                        <a href="{{ admin_url('users/transactions') }}" class="flex items-center w-full p-3 rounded bg-amber-100 text-amber-700 hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border rounded-full focus:outline-none border-amber-200">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold border rounded-full bg-amber-200 border-amber-300 focus:outline-none">
                    ...
                    @if ($notifications['count_pending_gigs'])
                        <a href="{{ admin_url('gigs') }}" class="flex items-center w-full p-3 text-green-700 bg-green-100 rounded hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border border-green-200 rounded-full focus:outline-none">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold bg-green-200 border border-green-300 rounded-full focus:outline-none">
                    ...
                    @if ($notifications['count_pending_projects'])
                        <a href="{{ admin_url('projects') }}" class="flex items-center w-full p-3 text-orange-700 bg-orange-100 rounded hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border border-orange-200 rounded-full focus:outline-none">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold bg-orange-200 border border-orange-300 rounded-full focus:outline-none">
                    ...
                    @if ($notifications['count_pending_bids_subscriptions'])
                        <a href="{{ admin_url('projects/bids/subscriptions') }}" class="flex items-center w-full p-3 text-purple-700 bg-purple-100 rounded hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border border-purple-200 rounded-full focus:outline-none">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold bg-purple-200 border border-purple-300 rounded-full focus:outline-none">
                    ...
                    @if ($notifications['count_reported_bids'])
                        <a href="{{ admin_url('reports/bids') }}" class="flex items-center w-full p-3 rounded bg-neutral-100 text-neutral-700 hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border rounded-full focus:outline-none border-neutral-200">
                                <svg class="w-4 h-4" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 6a3 3 0 013-3h10a1 1 0 01.8 1.6L14.25 8l2.55 3.4A1 1 0 0116 13H6a1 1 0 00-1 1v3a1 1 0 11-2 0V6z" clip-rule="evenodd"></path></svg>
                            </div>
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold border rounded-full bg-neutral-200 border-neutral-300 focus:outline-none">
                    ...
                    @if ($notifications['count_pending_projects_subscriptions'])
                        <a href="{{ admin_url('projects/subscriptions') }}" class="flex items-center w-full p-3 text-pink-700 bg-pink-100 rounded hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border border-pink-200 rounded-full focus:outline-none">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold bg-pink-200 border border-pink-300 rounded-full focus:outline-none">
                    ...
                    @if ($notifications['count_pending_refunds'])
                        <a href="{{ admin_url('refunds') }}" class="flex items-center w-full p-3 rounded bg-sky-100 text-sky-700 hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border rounded-full focus:outline-none border-sky-200">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold border rounded-full bg-sky-200 border-sky-300 focus:outline-none">
                    ...
                    @if ($notifications['count_reported_gigs'])
                        <a href="{{ admin_url('reports/gigs') }}" class="flex items-center w-full p-3 rounded bg-lime-100 text-lime-700 hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border rounded-full focus:outline-none border-lime-200">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold border rounded-full bg-lime-200 border-lime-300 focus:outline-none">
                    ...
                    @if ($notifications['count_reported_projects'])
                        <a href="{{ admin_url('reports/projects') }}" class="flex items-center w-full p-3 text-indigo-700 bg-indigo-100 rounded hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border border-indigo-200 rounded-full focus:outline-none">
                                <svg class="w-4 h-4" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g><path fill="none" d="M0 0h24v24H0z"></path><path d="M12.414 5H21a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h7.414l2 2zM11 9v2h2V9h-2zm0 3v5h2v-5h-2z"></path></g></svg>
                            </div>
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold bg-indigo-200 border border-indigo-300 rounded-full focus:outline-none">
                    ...
                    @if ($notifications['count_reported_users'])
                        <a href="{{ admin_url('reports/users') }}" class="flex items-center w-full p-3 text-yellow-700 bg-yellow-100 rounded hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border border-yellow-200 rounded-full focus:outline-none">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold bg-yellow-200 border border-yellow-300 rounded-full focus:outline-none">
                    ...
                    @if ($notifications['count_new_support_messages'])
                        <a href="{{ admin_url('support') }}" class="flex items-center w-full p-3 text-blue-700 bg-blue-100 rounded hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border border-blue-200 rounded-full focus:outline-none">
                                <svg class="w-4 h-4" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g><path fill="none" d="M0 0h24v24H0z"></path><path d="M2 8.994A5.99 5.99 0 0 1 8 3h8c3.313 0 6 2.695 6 5.994V21H8c-3.313 0-6-2.695-6-5.994V8.994zM14 11v2h2v-2h-2zm-6 0v2h2v-2H8z"></path></g></svg>
                            </div>
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold bg-blue-200 border border-blue-300 rounded-full focus:outline-none">
                    ...
                    @if ($notifications['count_pending_payouts'])
                        <a href="{{ admin_url('withdrawals') }}" class="flex items-center w-full p-3 rounded bg-fuchsia-100 text-fuchsia-700 hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border rounded-full focus:outline-none border-fuchsia-200">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold border rounded-full bg-fuchsia-200 border-fuchsia-300 focus:outline-none">
                    ...
                    @if ($notifications['count_pending_portfolio_projects'])
                        <a href="{{ admin_url('portfolios') }}" class="flex items-center w-full p-3 rounded bg-zinc-100 text-zinc-700 hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border rounded-full focus:outline-none border-zinc-200">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold border rounded-full bg-zinc-200 border-zinc-300 focus:outline-none">
                    ...
                    @if ($notifications['count_pending_verifications'])
                        <a href="{{ admin_url('verifications') }}" class="flex items-center w-full p-3 text-teal-700 bg-teal-100 rounded hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border border-teal-200 rounded-full focus:outline-none">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold bg-teal-200 border border-teal-300 rounded-full focus:outline-none">
                    ...
                    @if ($notifications['count_pending_checkout_payments'])
                        <a href="{{ admin_url('invoices') }}" class="flex items-center w-full p-3 rounded bg-slate-100 text-slate-700 hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border rounded-full focus:outline-none border-slate-200">
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold border rounded-full bg-slate-200 border-slate-300 focus:outline-none">
                    ...
                    @if ($notifications['count_pending_bids'])
                        <a href="{{ admin_url('projects/bids') }}" class="flex items-center w-full p-3 rounded bg-rose-100 text-rose-700 hover:bg-opacity-50">
        
                            {{-- Icon --}}
                            <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 border rounded-full focus:outline-none border-rose-200">
                                <svg class="w-4 h-4" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"></path></svg>
                            </div>
                            ...
                            <div class="flex items-center justify-between w-full ltr:pl-3 rtl:pr-3">
                                ...
                                {{-- Total --}}
                                <p class="flex items-center justify-center w-6 h-6 p-1 text-xs font-bold border rounded-full bg-rose-200 border-rose-300 focus:outline-none">
        ...
        <div class="bg-[#f8fafc] dark:bg-black dark:bg-opacity-60 h-full" :class="{ 'overflow-hidden': isSideMenuOpen }">
            ...
            <div class="flex flex-1 w-full h-full">
                ...
                {{-- Content --}}
                <main class="w-full h-full mt-20 md:ltr:ml-64 md:rtl:mr-64">
                    <div class="container !max-w-full py-12 px-4 sm:px-6 lg:px-14">
                        @yield('content')
                    </div>  
                </main> 
