        ...
        <div class="col-span-12 mb-10">
            <div
                ...
                <div class="flex-1 min-w-0">
                    <h2 class="text-sm font-extrabold text-gray-900 tracking-wider pb-1">{{ __('messages.t_gallery') }}
                    </h2>
                    <p class="text-gray-500 font-medium text-xs">
                        {{ __('messages.t_update_gig_gallery_documents_and_video') }}</p>
                </div>
                ...
                <div class="mb-14 flex justify-between items-center">
                    ...
                    <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0">
                        <button id="modal-add-youtube-video-button" type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500 hover:text-gray-600"
                                        ...
                                        <div class="thumbnail-holder">
                                            <div class="fileuploader-item-image">
                                                <img src="{{ placeholder_img() }}"
                                                    data-src="{{ src($img->img_thumb_id) }}" class="lazy"
                                                    draggable="false">
                                            </div>
                    ...
                    @if ($gig->image_thumb_id)
                        <div class="mt-3">
                            <img src="{{ src($gig->image_thumb_id) }}"
                                class="lazy h-24 w-24 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    @endif
                </div>
