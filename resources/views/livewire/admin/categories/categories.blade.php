                            ...
                            <div class="relative inline-block text-left">
                                ...
                                <div id="table-options-dropdown-{{ $c->id }}"
                                    ...
                                    <div class="py-1" role="none">
                                        ...
                                        {{-- Edit category --}}
                                        <a href="{{ admin_url('categories/edit/' . $c->uid) }}"
                                            ...
                                            <span
                                                class="text-xs font-medium">{{ __('messages.t_edit_category') }}</span>
                                        </a>
                                        ...
                                        <button
                                            ...
                                            <span
                                                class="text-xs font-medium">{{ __('messages.t_delete_category') }}</span>
