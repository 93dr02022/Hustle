                ...
                <thead>
                    @forelse ($subscriptions as $s)
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16"
                            wire:key="admin-dashboard-projects-subscriptions-{{ str_replace('-', '_', $s->uid) }}">
                            ...
                            <td
                                ...
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    {{-- Client --}}
                                    <a href="{{ admin_url('users/details/' . $s->project->client->uid) }}"
                                        class="h-10 w-10">
                                        <img class="w-full h-full rounded-md object-cover lazy"
                                            src="{{ placeholder_img() }}"
                                            data-src="{{ src($s->project->client->avatar_id) }}"
                                            alt="{{ $s->project->client->username }}">
                                    </a>
                                    ...
                                    <div>
                                        ...
                                        {{-- Title --}}
                                        <a href="{{ url('project/' . $s->project->pid . '/' . $s->project->slug) }}"
                                            target="_blank"
