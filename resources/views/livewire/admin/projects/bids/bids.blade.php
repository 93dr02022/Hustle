            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div class="mt-5 flex lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4">
                    ...
                    <span class="block lg:ltr:ml-3 lg:rtl:pr-3">
                        <a href="{{ admin_url('projects/bids/subscriptions') }}"
                ...
                <thead class="">
                    <tr class="bg-slate-200 dark:bg-zinc-600">
                        ...
                        <th
                            ...
                            @lang('messages.t_project')</th>

                        {{-- Freelancer --}}
                        <th
                            class="font-bold tracking-wider text-gray-600 px-5 py-4.5 border-b-0 whitespace-nowrap text-xs uppercase dark:text-zinc-300 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md rtl:text-right">
                            @lang('messages.t_freelancer')</th>
                        ...
                        <th
                            ...
                            @lang('messages.t_proposal_amount')</th>
                ...
                <thead>
                    @forelse ($bids as $bid)
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16"
                            wire:key="admin-dashboard-bids-{{ $bid->uid }}">
                            ...
                            <td
                                ...
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    {{-- Client --}}
                                    <a href="{{ admin_url('users/details/' . $bid->project->client->uid) }}"
                                        class="h-10 w-10">
                                        <img class="w-full h-full rounded-md object-cover lazy"
                                            src="{{ placeholder_img() }}"
                                            data-src="{{ src($bid->project->client->avatar_id) }}"
                                            alt="{{ $bid->project->client->username }}">
                                    </a>
                                    ...
                                    <div>
                                        ...
                                        {{-- Title --}}
                                        <a href="{{ url('project/' . $bid->project->pid . '/' . $bid->project->slug) }}"
                                            target="_blank"
                                            ...
                                            <nav class="flex" aria-label="Breadcrumb">
                                                <ol role="list"
                                                    ...
                                                    <li>
                                                        <div class="flex items-center">
                                                            <span
                                                                class="text-xs font-normal text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100">
                                                                <div
                                                                    class="flex items-center space-x-2 rtl:space-x-reverse text-gray-500 text-xs">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        {{-- Divider --}}
                                                                        <span
                                                                            class="text-xs text-gray-400 px-px">/</span>
                                                    ...
                                                    <li>
                                                        <div class="flex items-center">
                                                            <span
                                                                class="flex-shrink-0 h-4 w-4 text-gray-400 ltr:ml-3 rtl:mr-3">|</span>
                                                            <span
                                                                ...
                                                                <div
                                                                    class="flex items-center space-x-2 rtl:space-x-reverse text-gray-500 text-xs">
                                                                    <svg class="h-4 w-4 text-zinc-400"
                                                                        stroke="currentColor" fill="currentColor"
                            ...
                            {{-- Freelancer --}}
                            <td
                                class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-48">
                                <a href="{{ url('profile', $bid->user->username) }}" target="_blank"
                                    class="flex items-center">
                                    <div class="w-8 h-8">
                                        <img class="w-full h-full rounded object-cover lazy"
                                            src="{{ placeholder_img() }}"
                                            data-src="{{ src($bid->user->avatar_id) }}"
                                            alt="{{ $bid->user->username }}" />
                                    </div>
                                    <div class="ltr:pl-4 rtl:pr-4">
                                        <p class="font-medium text-sm flex items-center">
                                            <span
                                                class="text-zinc-600 hover:text-primary-600">{{ $bid->user->username }}</span>
                                            @if ($bid->user->status === 'verified')
                                                <img data-tooltip-target="tooltip-account-verified-{{ $bid->user->id }}"
                                                    class="ltr:ml-0.5 rtl:mr-0.5 h-3.5 w-3.5 -mt-0.5"
                                                    src="{{ url('img/auth/verified-badge.svg') }}"
                                                    alt="{{ __('messages.t_account_verified') }}">
                                                <div id="tooltip-account-verified-{{ $bid->user->id }}"
                                                    role="tooltip"
                                                    class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                            ...
                            <td
                                ...
                                @switch($bid->status)
                                    ...
                                    @case('active')
                                        <span
                                            class="bg-emerald-100 text-emerald-700 px-4 inline-block leading-9 h-9 rounded-3xl font-medium text-xs whitespace-nowrap">
                                    ...
                                    @case('pending_approval')
                                        <div class="flex items-center flex-col">
                                            <div
                                                class="bg-yellow-100 text-yellow-600 px-4 leading-9 h-9 rounded-3xl font-medium text-xs flex items-center space-x-3 rtl:space-x-reverse">
                                                ...
                                                <div class="flex items-center space-x-1 rtl:space-x-reverse">
                                                    ...
                                                    <div>
                                                        ...
                                                        {{-- Button --}}
                                                        <button type="button"
                                                            data-tooltip-target="tooltip-actions-approve-{{ $bid->uid }}"
                                                            id="modal-approve-bid-button-{{ $bid->uid }}"
                                                            class="flex items-center justify-center h-6 w-6 rounded-full border border-transparent bg-white text-yellow-600 hover:bg-transparent hover:border-yellow-600">
                                                        ...
                                                        {{-- Tooltip --}}
                                                        <x-forms.tooltip id="tooltip-actions-approve-{{ $bid->uid }}"
                                                            :text="__('messages.t_approve')" />
                                                    ...
                                                    <div>
                                                        ...
                                                        {{-- Button --}}
                                                        <button type="button"
                                                            data-tooltip-target="tooltip-actions-reject-{{ $bid->uid }}"
                                                            id="modal-reject-bid-button-{{ $bid->uid }}"
                                                            class="flex items-center justify-center h-6 w-6 rounded-full border border-transparent bg-white text-yellow-600 hover:bg-transparent hover:border-yellow-600">
                                                            <svg class="w-4 h-4" stroke="currentColor" fill="currentColor"
                                                                stroke-width="0" viewBox="0 0 24 24"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        {{-- Tooltip --}}
                                                        <x-forms.tooltip id="tooltip-actions-reject-{{ $bid->uid }}"
                                                            :text="__('messages.t_reject')" />
                                    ...
                                    @case('pending_payment')
                                        <span
                                            class="bg-amber-100 text-amber-600 px-4 inline-block leading-9 h-9 rounded-3xl font-medium text-xs whitespace-nowrap">
                                    ...
                                    @case('hidden')
                                        <span
                                            class="bg-gray-100 text-gray-600 px-4 inline-block leading-9 h-9 rounded-3xl font-medium text-xs whitespace-nowrap">
                                    ...
                                    @case('rejected')
                                        <span
                                            class="bg-red-100 text-red-600 px-4 inline-block leading-9 h-9 rounded-3xl font-medium text-xs whitespace-nowrap">
                            ...
                            <td
                                ...
                                <div class="flex items-center justify-center space-x-4 rtl:space-x-reverse">
                                    ...
                                    <div>
                                        <button type="button"
                                            data-tooltip-target="tooltip-actions-preview-{{ $bid->uid }}"
                                            id="modal-preview-bid-button-{{ $bid->uid }}"
                                        ...
                                        <x-forms.tooltip id="tooltip-actions-preview-{{ $bid->uid }}"
                                            :text="__('messages.t_preview_bid')" />
                                    </div>

                                    {{-- Delete --}}
                                    <div>
                                        <button type="button"
                                            data-tooltip-target="tooltip-actions-delete-{{ $bid->uid }}"
                                            id="modal-delete-bid-button-{{ $bid->uid }}"
                                            class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
                                            <svg class="w-4 h-4" stroke="currentColor" fill="currentColor"
                                                stroke-width="0" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <x-forms.tooltip id="tooltip-actions-delete-{{ $bid->uid }}"
                                            :text="__('messages.t_delete_bid')" />
                                    </div>
                        ...
                        {{-- Preview Modal --}}
                        <x-forms.modal id="modal-preview-bid-container-{{ $bid->uid }}"
                            target="modal-preview-bid-button-{{ $bid->uid }}"
                            uid="modal_preview_bid_{{ $bid->uid }}" placement="center-center" size="max-w-2xl">
                            ...
                            <x-slot name="content">
                                ...
                                <div class="w-full relative">
                                    <div class="relative">
                                        ...
                                        <div class="mb-8">
                                            ...
                                            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                                ...
                                                <a href="{{ url('profile', $bid->user->username) }}" class="block">
                                                    <img class="rounded-full h-12 w-12 object-cover object-center lazy"
                                                        src="{{ placeholder_img() }}"
                                                        data-src="{{ src($bid->user->avatar_id) }}"
                                                        alt="{{ $bid->user->username }}">
                                                </a>
                                                ...
                                                <div class="space-y-0.5">
                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        @if ($bid->user->fullname)
                                                            <span
                                                                class="font-medium text-zinc-900 text-sm hover:text-black ltr:pr-1 rtl:pl-1">
                                                                {{ $bid->user->fullname }}
                                                            </span>
                                                        @endif

                                                        {{-- Username --}}
                                                        <a href="{{ url('profile', $bid->user->username) }}"
                                                    ...
                                                    {{-- User details --}}
                                                    <div
                                                        class="flex items-center space-x-3 rtl:space-x-reverse text-[13px]">
                                                        ...
                                                        @if ($bid->user->country)
                                                            <p class="flex items-center space-x-1 rtl:space-x-reverse">
                                                                <img class="h-4 ltr:pr-0.5 rtl:pl-0.5 -mt-0.5 lazy"
                                                                    src="{{ placeholder_img() }}"
                                                                    data-src="{{ countryFlag($bid->user->country->code) }}"
                                                                    alt="{{ $bid->user->country->name }}">
                                                        ...
                                                        {{-- Rating --}}
                                                        <p
                                                            class="flex shrink-0 items-center space-x-1 rtl:space-x-reverse">
                                                            <svg aria-hidden="true"
                                                                class="w-4 h-4 {{ $bid->user->rating() == 0 ? 'text-gray-400' : 'text-amber-500' }} -mt-0.5"
                                                        ...
                                                        @if ($bid->user->status === 'verified')
                                                            ...
                                                            <div
                                                                class="flex shrink-0 items-center space-x-1 rtl:space-x-reverse">
                                                                <svg class="w-4 h-4 text-blue-500 -mt-0.5"
                                                                    stroke="currentColor" fill="currentColor"
                                        ...
                                        {{-- Bid body --}}
                                        <p
                                            class="mb-2 font-light text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                            {!! nl2br($bid->message) !!}
                                        </p>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 md:gap-x-4 gap-y-5">
                                    ...
                                    @if ($bid->is_awarded)
                                        <div
                                            class="bg-green-50 rounded-lg flex flex-col items-center justify-center p-6">
                                            ...
                                            <h2
                                                class="text-green-600 text-sm font-semibold whitespace-nowrap truncate max-w-[100px]">
                                                @lang('messages.t_awarded')</h2>
                                        </div>
                                    @endif
                                    ...
                                    @if ($bid->is_sponsored)
                                        <div
                                            class="bg-red-50 rounded-lg flex flex-col items-center justify-center p-6">
                                            <svg class="h-5 mb-2 text-red-600 w-5" stroke="currentColor"
                                                fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path fill="none" d="M0 0h24v24H0z"></path>
                                            ...
                                            <h2
                                                class="text-red-600 text-sm font-semibold whitespace-nowrap truncate max-w-[100px]">
                                                @lang('messages.t_sponsored')</h2>
                                        </div>
                                    @endif
                                    ...
                                    @if ($bid->is_sealed)
                                        <div
                                            class="bg-blue-50 rounded-lg flex flex-col items-center justify-center p-6">
                                            ...
                                            <h2
                                                class="text-blue-600 text-sm font-semibold whitespace-nowrap truncate max-w-[100px]">
                                                @lang('messages.t_sealed')</h2>
                                        </div>
                                    @endif
                                    ...
                                    @if ($bid->is_highlight)
                                        <div
                                            class="bg-amber-50 rounded-lg flex flex-col items-center justify-center p-6">
                                            ...
                                            <h2
                                                class="text-amber-600 text-sm font-semibold whitespace-nowrap truncate max-w-[100px]">
                                                @lang('messages.t_highlighted')</h2>
                                        </div>
                                    @endif
                        ...
                        {{-- Approve Modal --}}
                        <x-forms.modal id="modal-approve-bid-container-{{ $bid->uid }}"
                            target="modal-approve-bid-button-{{ $bid->uid }}"
                            uid="modal_approve_bid_{{ $bid->uid }}" placement="center-center" size="max-w-md">
                            ...
                            <x-slot name="footer">
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    {{-- Accept --}}
                                    <button type="button" wire:click="approve('{{ $bid->id }}')"
                        ...
                        {{-- Reject Modal --}}
                        <x-forms.modal id="modal-reject-bid-container-{{ $bid->uid }}"
                            target="modal-reject-bid-button-{{ $bid->uid }}"
                            uid="modal_reject_bid_{{ $bid->uid }}" placement="center-center" size="max-w-md">
                                ...
                                <div class="w-fill mb-6">
                                    ...
                                    <div class="relative w-full shadow-sm">
                                        ...
                                        <textarea wire:model.defer="rejection_reason" id="bid-report-description-input"
                                            ...
                                            rows="8" placeholder="{{ __('messages.t_enter_rejection_reason') }}"></textarea>
                                        ...
                                        <div
                                            ...
                                            <svg class="w-5 h-5 text-gray-500" stroke="currentColor"
                                                fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    @error('rejection_reason')
                                        <p
                                            class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
                            ...
                            <x-slot name="footer">
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    {{-- Reject --}}
                                    <button type="button" wire:click="reject('{{ $bid->id }}')"
                                        wire:loading.attr="disabled"
                        ...
                        {{-- Delete modal --}}
                        <x-forms.modal id="modal-delete-bid-container-{{ $bid->uid }}"
                            target="modal-delete-bid-button-{{ $bid->uid }}"
                            uid="modal_delete_bid_{{ $bid->uid }}" placement="center-center" size="max-w-md">
                            ...
                            <x-slot name="content">
                                <div class="flex flex-col items-center">
                                    ...
                                    <div class="h-16 w-16 flex items-center justify-center bg-red-100 rounded-full">
                                        <svg class="w-7 h-7 text-red-400 -mt-1" stroke="currentColor"
                                            fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g>
                                                <path fill="none" d="M0 0h24v24H0z"></path>
                            ...
                            <x-slot name="footer">
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    {{-- Delete --}}
                                    <button type="button" wire:click="delete('{{ $bid->id }}')"
                                        wire:loading.attr="disabled"
                                        class="inline-flex justify-center items-center rounded border font-semibold focus:outline-none px-3 py-2 leading-5 text-xs tracking-wide border-transparent bg-red-500 text-white hover:bg-red-600 focus:ring focus:ring-red-500 focus:ring-opacity-25 disabled:bg-gray-200 disabled:hover:bg-gray-200 disabled:text-gray-500 disabled:cursor-not-allowed">
