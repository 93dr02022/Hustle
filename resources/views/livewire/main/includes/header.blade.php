                    ...
                    <div class="relative hidden md:inline-block ltr:ml-4 rtl:mr-4" x-data="{ open: false }">
                        ...
                        <div x-show="open" style="display: none" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="transform opacity-0 scale-75"
                            ...
                            <div class="py-1.5 px-3.5">
                                ...
                                <a href="/account/referral" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="flex-none w-5 h-5 text-gray-400 ltr:mr-3 rtl:ml-3 group-hover:text-primary-600" viewBox="0 0 16 16">
                                    ...
                                    <span class="text-xs font-semibold text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">Referral</span>
                                </a>
