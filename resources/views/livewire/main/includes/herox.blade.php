    ...
    <div class="bg-white flex flex-col grow min-h-[370px] xs:min-h-[380px] sm:min-h-[385px] md:max-h-[430px] h-full w-full relative">
                        ...
                        <div class="w-full swiper-slide">
                            <div class="h-full grid grid-cols-1">
                                ...
                                <div class="col-start-1 row-start-1 h-full">
                                    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-11 md:h-full md:gap-x-14 px-4 sm:px-6 lg:px-8">
                                        <div class="col-span-6">
                                            <div class="h-[calc(100%_-_3rem)]">
                                                <div class="bg-white flex flex-col border-l-[5px] border-[#F18522] pl-4 mt-10 md:mt-14">
        ...
        <div class="flex-shrink-0 absolute z-20 bottom-0 left-[0] md:top-[44%] right-[0] px-4 lg:bottom-[40px]">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div
                    class="max-w-[620px] py-2 sm:py-5 px-3 xs:px-4 md:px-7 mb-12 z-10 backdrop-blur-[5px] sm:backdrop-blur-[15px] border-[0.5px] border-[#1D46F5] sm:rounded-[10px] lg:rounded-[18px] rounded-md bg-[rgba(217,217,217,0.05)]">
                        ...
                        <div class="flex items-center mb-2 sm:mb-4">
                            <div class="relative w-full">
                                ...
                                <input type="search" name="q" wire:model.debounce.200ms="q" wire:keydown.enter="enter" x-ref="search" x-on:click="open = true"
                                    class="bg-white border border-[#f1f1f1] text-gray-900 text-sm font-medium rounded-md block w-full ltr:pl-10 rtl:pr-10 px-2.5 py-4 focus:outline-none focus:ring-0 shadow-sm"
                    ...
                    <div class="items-center hidden text-sm font-semibold text-[#1D46F5] sm:flex whitespace-nowrap">
                        ...
                        <ul class="flex flex-wrap gap-2 ml-3">
                            @foreach (modelCaches('tags_cache') as $tag)
                                <li class="flex whitespace-nowrap">
                                    <a href="{{ url('categories', $tag->slug) }}"
                                        class="border-[1.5px] border-[#1D46F5] rounded-[40px] hover:bg-white hover:text-gray-700 transition-all duration-200 px-1.5 py-0.5 text-xs">
                                        {{ $tag->name }}
                                    </a>
                                </li>
                            @endforeach
