            ...
            <div class="col-span-12">
                <div class="bg-[#F1D3BD] w-full pt-10">
                    <div class="grid grid-cols-1 md:grid-cols-12">
                        <div class="pb-28 md:col-span-8" style="background-image: url('/img/home/square.png')">
                            ...
                            {{-- sellers slider --}}
                            <div class="grid grid-cols-1">
                                <div class="relative w-full col-start-1 row-start-1">
                                    <div class="w-full h-full bg-white md:mx-w-[90%] absolute bottom-[-20%] right-[4%]">
                                    </div>
                                </div>

                                <div class="z-20 col-start-1 row-start-1">
                                    <div class="right-0 max-w-3xl swiper sellers-swiper">
                                        <div class="swiper-wrapper">
                        ...
                        {{-- upcoming deliveries and offers column --}}
                        <div class="md:col-span-4 bg-[#F1F4FF] flex flex-col">
                            <div class="pb-5">
                                <div class="bg-white py-3 text-[#D76700] px-4 font-bold">
                                    Upcoming Deliveries
                                </div>
                            </div>
                            <div class="pb-5">
