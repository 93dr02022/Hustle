                ...
                <fieldset>
                    ...
                    <div class="text-center mb-12">
                        ...
                        <div
                            ...
                            <svg class="mx-auto h-9 w-9 text-gray-400 dark:text-gray-300" stroke="currentColor"
                        ...
                        <h2 class="mt-4 text-base font-bold text-gray-700 dark:text-gray-100">
                            {{ __('messages.t_checkout') }}</h2>
                        <div class="flex items-center justify-center text-green-400 hover:text-green-500 mt-1">
                            <svg class="h-5 w-5 ltr:mr-1 rtl:ml-1" stroke="currentColor" fill="currentColor"
                                stroke-width="0" version="1.2" baseProfile="tiny" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    @if (is_null($payment_method))
                        <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-3 sm:gap-x-4">
                            ...
                            @if (settings('stripe')->is_enabled)
                                <div wire:click="$set('payment_method', 'stripe')"
                            ...
                            @if (settings('paypal')->is_enabled)
                                <div wire:click="$set('payment_method', 'paypal')"
                            ...
                            @if (settings('offline_payment')->is_enabled)
                                <div wire:click="$set('payment_method', 'offline')"
                            ...
                            @if (settings('flutterwave')->is_enabled)
                                <div wire:click="$set('payment_method', 'flutterwave')"
                            ...
                            @if (settings('cashfree')->is_enabled)
                                <div wire:click="$set('payment_method', 'cashfree')"
                            ...
                            @if (settings('mollie')->is_enabled)
                                <div wire:click="$set('payment_method', 'mollie')"
                            ...
                            @if (settings('xendit')->is_enabled)
                                <div wire:click="$set('payment_method', 'xendit')"
                            ...
                            @if (settings('mercadopago')->is_enabled)
                                <div wire:click="$set('payment_method', 'mercadopago')"
                            ...
                            @if (settings('vnpay')->is_enabled)
                                <div wire:click="$set('payment_method', 'vnpay')"
                            ...
                            @if (settings('paymob')->is_enabled)
                                <div wire:click="$set('payment_method', 'paymob')"
                            ...
                            @if (settings('paytabs')->is_enabled)
                                <div wire:click="$set('payment_method', 'paytabs')"
                            ...
                            @if (settings('paytr')->is_enabled)
                                <div wire:click="$set('payment_method', 'paytr')"
                            ...
                            @if (settings('razorpay')->is_enabled)
                                <div wire:click="$set('payment_method', 'razorpay')"
                            ...
                            @if (settings('jazzcash')->is_enabled)
                                <div wire:click="$set('payment_method', 'jazzcash')"
                            ...
                            @if (settings('youcanpay')->is_enabled)
                                <div wire:click="$set('payment_method', 'youcanpay')"
                            ...
                            @if (settings('nowpayments')->is_enabled)
                                <div wire:click="$set('payment_method', 'nowpayments')"
                            ...
                            @if (settings('epoint')->is_enabled)
                                <div wire:click="$set('payment_method', 'epoint')"
                    ...
                    @if (in_array($payment_method, [
                        ...
                        <div class="w-full mt-14" wire:key="checkout-key-summary">
                                                    ...
                                                    <div
                                                        ...
                                                        @else
                                                            @if (settings($payment_method)->logo)
                                                                <img src="{{ placeholder_img() }}"
                                                                    data-src="{{ src(settings($payment_method)->logo) }}"
                                                                    class="lazy max-w-[50px]">
                                                            @endif
                                                            <span
                                                                class="ltr:pl-3 rtl:pr-3 font-bold">{{ settings($payment_method)->name }}</span>
                                                        @endif
                                                    </div>
                                                </dd>
                                            </div>
                            ...
                            @if ($payment_method === 'wallet' && auth()->user()->balance_available >= $exchange_total_amount)
                                <div class="w-full">
                                    <div
                                        class="flex items-center justify-center text-2xl text-gray-900 font-black dark:text-white">
                                        @money(auth()->user()->balance_available, settings('currency')->code, true)
                                    </div>
                                    <div
                                        class="text-center text-xs mt-2 tracking-wide text-gray-500 dark:text-gray-300">
                            ...
                            @if ($payment_method === 'offline' && settings('offline_payment')->is_enabled)
                                <div class="w-full">
                                    ...
                                    {{-- Bank details --}}
                                    <div
                                        class="text-sm font-normal mt-2 tracking-wide text-gray-500 dark:text-gray-200">
                            ...
                            @if ($payment_method === 'flutterwave' && settings('flutterwave')->is_enabled)
                                <div class="w-full">
                                    ...
                                    {{-- Pay --}}
                                    <div class="mt-8">
                                        <button @click="window.makeFlutterwavePayment" id="flutterwave-payment-button"
                                    ...
                                    <div class="grid grid-cols-12 md:gap-x-5 gap-y-5" id="cashfree-payment-card">
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <div class="relative w-full">
                                                <input type="text" id="cashfree-input-phone" minlength="10"
                                                    maxlength="10"
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <div class="relative w-full">
                                                <input data-card-holder type="text" id="cashfree-input-holder"
                                                    class="border border-gray-300 text-gray-900 text-sm rounded-lg font-medium focus:ring-primary-500 focus:border-primary-500 block w-full ltr:pr-12 rtl:pl-12 p-4 dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <div class="relative w-full">
                                                <input data-card-number type="text" id="cashfree-input-number"
                                                    class="border border-gray-300 text-gray-900 text-sm rounded-lg font-medium focus:ring-primary-500 focus:border-primary-500 block w-full ltr:pr-12 rtl:pl-12 p-4 dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        ...
                                        const config = {
                                            onPaymentSuccess: function(data) {
                                                ...
                                                if (data.order.status == "PAID") {
                                                    ...
                                                    document.getElementById('cashfree-payment-button').textContent =
                                                        "{{ __('messages.t_pay') }}";
                                    ...
                                    @else
                                        <div class="grid grid-cols-1 gap-y-7 md:gap-x-4">
                                            ...
                                            <div class="col-span-12 md:col-span-6">
                                                ...
                                                <div class="relative w-full">
                                                    <input wire:model.defer="paymob_lastname" type="text"
                                                        ...
                                                        class="border border-gray-300 text-gray-900 text-sm rounded-lg font-medium focus:ring-primary-500 focus:border-primary-500 block w-full ltr:pr-12 rtl:pl-12 p-4 dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                        placeholder="{{ __('messages.t_enter_lastname') }}" required>
                                                    <div
                                                        class="absolute inset-y-0 ltr:right-0 rtl:left-0 flex items-center ltr:pr-3 rtl:pl-3">
                                                        <svg class="w-5 h-5 text-gray-400" stroke="currentColor"
                                                            fill="none" stroke-width="2" viewBox="0 0 24 24"
                                            ...
                                            <div class="col-span-12 mt-6">
                                                <x-forms.button action="getPayMobPaymentKey" :text="__('messages.t_next')"
                                                    :block="true" />
                                            </div>
                            ...
                            @if ($payment_method === 'youcanpay' && settings('youcanpay')->is_enabled)
                                <div class="w-full">
                                    <script>
                                        window.location = "{{ $this->generateYoucanpayUrl() }}";
                                    </script>
                                </div>
                            @endif
