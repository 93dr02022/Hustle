                ...
                <div
                    ...
                    <div class="divide-y divide-gray-200 dark:divide-zinc-700">
                        <div class="px-4 py-5 sm:px-6">
                            <h2 class="text-sm font-semibold tracking-wide text-gray-700 dark:text-gray-100">
                                {{ __('messages.t_conversation') }}</h2>
                        </div>
                                    ...
                                    <li>
                                        <div class="relative pb-8">
                                            ...
                                            <div class="relative flex items-start space-x-3 rtl:space-x-reverse">
                                                ...
                                                <div class="relative">
                                                    <img class="h-10 w-10 rounded-full bg-gray-400 dark:bg-zinc-700 flex items-center justify-center ring-8 ring-white dark:ring-transparent object-cover lazy"
                                                        src="{{ placeholder_img() }}"
                                                    ...
                                                    <div>
                                                        <div class="text-sm">
                                                            <a href="{{ url('profile', $msg->author_type === 'buyer' ? $msg->buyer->username : $msg->seller->username) }}"
                                                                target="_blank"
                                                                class="font-medium text-gray-900 dark:text-gray-100 hover:text-primary-600">{{ $msg->author_type === 'buyer' ? $msg->buyer->username : $msg->seller->username }}</a>
                                                        </div>
                            ...
                            <div class="mt-6">
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    <div class="flex-shrink-0">
                                        <div class="relative">
                                            <img class="h-10 w-10 rounded-full bg-gray-400 dark:bg-zinc-700 flex items-center justify-center object-cover lazy"
                                                src="{{ placeholder_img() }}"
                ...
                <div class="space-y-6 pb-16">
                    ...
                    <div class="mb-14">
                        <div class="aspect-w-10 aspect-h-7 block w-full overflow-hidden rounded-md">
                            <img src="{{ placeholder_img() }}" data-src="{{ src($refund->item->gig->thumbnail) }}"
                                alt="{{ $refund->item->gig->title }}" class="lazy object-cover">
                        </div>
                        <div class="mt-4">
                            <div>
                    ...
                    {{-- Item details --}}
                    <div>
                        <h3 class="text-gray-900 dark:text-gray-300 text-sm font-bold tracking-wide">
                            {{ __('messages.t_details') }}</h3>
                        <dl
                            class="mt-2 divide-y divide-gray-200 border-t border-b border-gray-200 dark:divide-zinc-600 dark:border-zinc-600">
                            ...
                            <div class="flex justify-between py-3 text-sm font-medium">
                                ...
                                <dd class="text-gray-900 dark:text-gray-200">
                                    {{ format_date($refund->created_at, 'ago') }}</dd>
                            </div>
                    ...
                    <div>
                        <h3 class="text-gray-900 dark:text-gray-300 text-sm font-bold tracking-wide">
                            {{ __('messages.t_refund_reason') }}</h3>
                        <div class="mt-2">
