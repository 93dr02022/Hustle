        ...
        <div class="mx-auto max-w-7xl">
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div class="mt-5 flex lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4 justify-between">
                    ...
                    <span class="block lg:ltr:ml-3 lg:rtl:pr-3">
                        <a href="{{ url('seller/withdrawals/create') }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 text-gray-500 ltr:mr-2 rtl:ml-2 dark:text-zinc-200" fill="none"
                    ...
                    {{-- Withdrawal settings --}}
                    <span class="block lg:ltr:ml-3 lg:rtl:pr-3">
                        <a href="{{ url('seller/withdrawals/settings') }}"
                            class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-500 rounded-sm shadow-sm text-[13px] font-medium text-gray-700 dark:text-zinc-200 bg-white dark:bg-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-primary-600 dark:focus:ring-offset-zinc-500 whitespace-nowrap">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 text-gray-500 ltr:mr-2 rtl:ml-2 dark:text-zinc-200" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="rounded-md bg-green-100 dark:bg-zinc-700/40 p-4 mb-4">
                <div class="flex">
                    ...
                    <div class="ltr:ml-3 rtl:mr-3">
                        <h3 class="text-sm font-medium text-green-800 dark:text-zinc-400">
                            {{ __('messages.t_congratulations') }}</h3>
                ...
                <thead>
                    @forelse ($withdrawals as $w)
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16"
                            wire:key="freelancer-dashboard-payouts-{{ $w->uid }}">
                            ...
                            <td
                                ...
                                <div class="flex items-center">
                                    @if ($w->gateway_provider_name === 'paypal')
                                        ...
                                        <span
                                            class="font-medium text-sm dark:text-zinc-200">{{ $w->gateway_provider_id }}</span>
                            ...
                            <td
                                ...
                                @switch($w->status)
                                    @case('pending')
                                        <span
                                            class="text-amber-500 text-[13px] font-medium tracking-wide">{{ __('messages.t_pending') }}</span>
                                    @break

                                    @case('paid')
                                        <span
                                            class="text-green-500 text-[13px] font-medium tracking-wide">{{ __('messages.t_paid') }}</span>
                                    @break

                                    @case('rejected')
                                        <span
                                            class="text-red-500 text-[13px] font-medium tracking-wide">{{ __('messages.t_rejected') }}</span>
                                    @break
