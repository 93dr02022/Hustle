    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 mb-10">
        <nav class="justify-between px-4 py-3 text-gray-700 border border-gray-100 rounded-lg shadow-sm sm:flex sm:px-5 bg-white dark:bg-zinc-800 dark:border-zinc-700 dark:shadow-none"
            ...
            <div class="flex items-center">
                ...
                {{-- Share gig --}}
                <span class="block ltr:mr-4 rtl:ml-4">
                    <button id="modals-share-btn"
                        class="inline-flex items-center px-4 py-2 border border-primary-600 rounded shadow-sm text-[13px] font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary-50 focus:ring-primary-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-50 ltr:mr-2 rtl:ml-2"
                            viewBox="0 0 20 20" fill="currentColor">
                            <path
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
            ...
            <div class="col-span-12 z-[1]">
                <div class="grid grid-cols-12 sm:gap-x-6 gap-y-4">
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-3">
                        <div
                            class="relative block shadow-sm overflow-hidden border border-gray-200 dark:border-zinc-700 p-5 mt-6 bg-white dark:bg-zinc-800 rounded-lg intro-x">
                            <div class="flex flex-wrap gap-3">
                                <div class="ltr:mr-auto rtl:ml-auto">
                                    <div
                                        class="text-gray-500 dark:text-gray-300 flex items-center leading-3 text-sm font-bold">
                                        {{ __('messages.t_total_sales') }}
                                    </div>
                                    <div
                                        class="text-black dark:text-gray-100 relative text-2xl font-black leading-5 mt-4">
                                        {{ number_format($gig->counter_sales) }}
                                    </div>
                                </div>
                                <div
                                    class="flex items-center justify-center w-12 h-12 rounded-full bg-gray-50 text-gray-400 dark:bg-zinc-700 dark:text-zinc-300">
            ...
            <div class="col-span-12 lg:col-span-5">
                ...
                <div class="w-full">
                    <div
                        ...
                        {{-- Section title --}}
                        <div
                            class="bg-white border-b border-gray-100 px-8 py-4 rounded-t-md dark:bg-zinc-800 dark:border-zinc-700/40">
                            <div
                                ...
                                <div class="ltr:ml-4 rtl:mr-4 mt-4">
                                    ...
                                    <p class="text-[13px] font-normal text-gray-400 dark:text-gray-300">
            ...
            <div class="col-span-12 lg:col-span-4 mt-3 2xl:mt-8">
                ...
                {{-- Section title --}}
                <div
                    class="mb-6 bg-white shadow-sm rounded-md border border-gray-200 dark:bg-zinc-800 dark:border-zinc-700">
                        ...
                        <div class="bg-white rounded-lg px-5 py-3 mb-3 flex items-center zoom-in dark:bg-zinc-900">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img class="lazy" alt="{{ $order->order->buyer->username }}"
                                    src="{{ placeholder_img() }}"
                                    data-src="{{ src($order->order->buyer->avatar_id) }}">
                            </div>
                            <div class="ltr:ml-4 ltr:mr-auto rtl:mr-4 rtl:ml-auto">
                                <a href="{{ url('profile', $order->order->buyer->username) }}"
                                    class="block font-medium text-[13px] pb-0.5 dark:text-gray-200">{{ $order->order->buyer->username }}</a>
                                <div
                                    class="text-slate-500 dark:text-zinc-300 mt-0.5 text-[13px] w-52 text-ellipsis block overflow-hidden">
            ...
            <div class="col-span-12 lg:col-span-4 mt-3 2xl:mt-8">
                ...
                @forelse ($referrers as $ref)
                    <div class="intro-x">
                        <div
                            class="flex space-x-3 rtl:space-x-reverse bg-white rounded-lg px-5 py-3 mb-3 justify-between items-center zoom-in dark:bg-zinc-900">
                            ...
                            <div class="flex-1 space-y-1">
                                <div class="flex items-center justify-between">
                                    ...
                                    @if (parse_url(url('/'))['host'] == $ref->visit_from)
                                        <div class="block font-medium text-[13px] pb-0.5 dark:text-gray-200">
                                            {{ $ref->visit_from }}</div>
                                    @else
                                        <a href="{{ url('redirect?to=' . safeEncrypt($ref->referrer)) }}"
                                            target="_blank"
                                            class="block font-medium text-[13px] pb-0.5 dark:text-gray-200">{{ $ref->visit_from }}</a>
                                    @endif

                                    <div class="text-gray-400 dark:text-zinc-100 text-[13px] font-medium">
                                        {{ $ref->count }}</div>
                                </div>
                                <div class="text-slate-500 dark:text-zinc-300 mt-0.5 text-[13px] w-52 text-ellipsis block overflow-hidden"
                                    title="{{ $ref->referrer }}">{{ $ref->referrer }}</div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-4 mt-3 2xl:mt-8">
                ...
                @forelse ($cities as $city)
                    <div class="intro-x">
                        <div class="bg-white rounded-lg px-5 py-3 mb-3 flex items-center zoom-in dark:bg-zinc-900">
                            <div
                                class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden ring-gray-100 ring-1 dark:ring-transparent">
                            ...
                            <div class="ltr:ml-4 ltr:mr-auto rtl:mr-4 rtl:ml-auto">
                                ...
                                <div
                                    class="text-slate-500 dark:text-zinc-300 mt-0.5 text-[13px] w-52 text-ellipsis block overflow-hidden">
                                    {{ $city->country_name }}</div>
                            </div>
                            <div class="text-gray-400 dark:text-zinc-100 text-[13px] font-medium">{{ $city->count }}
                            </div>
                        </div>
                    </div>
                @empty
        ...
        <x-slot name="content">
            <div class="flex items-center justify-center flex-col space-y-6 sm:space-y-0 sm:flex-row">
                ...
                <div class="grid items-center justify-center mx-4">
                    <a href="https://www.facebook.com/share.php?u={{ url('service', $gig->slug) }}&t={{ $gig->title }}"
                        target="_blank"
                ...
                {{-- Twitter --}}
                <div class="grid items-center justify-center mx-4">
                    <a href="https://twitter.com/intent/tweet?text={{ $gig->title }}%20-%20{{ url('service', $gig->slug) }}%20"
                        target="_blank"
                ...
                {{-- Linkedin --}}
                <div class="grid items-center justify-center mx-4">
                    <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ url('service', $gig->slug) }}&title={{ $gig->title }}&summary={{ $gig->title }}"
                        target="_blank"
                ...
                {{-- Whatsapp --}}
                <div class="grid items-center justify-center mx-4">
                    <a href="https://api.whatsapp.com/send?text={{ $gig->title }}%20{{ url('service', $gig->slug) }}"
                        target="_blank"
                ...
                map() {
                    $(function() {
                        ...
                        data.forEach((element, index) => {
                            ...
                            const el = {
                                [element.country_code]: Number(element.count)
                            };
