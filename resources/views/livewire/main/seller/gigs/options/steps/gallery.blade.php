<div class="w-full" x-data="window.HtBWuUxgpMyrQEM" x-init="initialize">
    ...
    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
            ...
            <div
                    ...
                    <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0">
                        <button id="modal-add-youtube-video-button" type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 text-gray-500 hover:text-gray-600 dark:text-zinc-300 dark:hover:text-white"
                                    ...
                                    <div class="fileuploader-item-inner">
                                        ...
                                        <div class="thumbnail-holder">
                                            <div class="fileuploader-item-image">
                                                <img class="lazy" src="{{ placeholder_img() }}"
                                                    data-src="{{ src($img->img_thumb_id) }}" draggable="false">
                                            </div>
                ...
                <div class="w-full">
                    ...
                    @if ($gig->image_thumb_id)
                        <div class="mt-3">
                            <img src="{{ src($gig->image_thumb_id) }}"
                                class="h-24 w-24 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    @endif
                </div>
        ...
        <div class="col-span-12 lg:col-span-5">
            ...
            {{-- Video --}}
            @if ($video_link)
                <div class="bg-white rounded-lg shadow-sm border border-gray-100 px-8 py-6 dark:bg-zinc-800 dark:border-zinc-700"
                    wire:key="section_video">
                ...
                <div class="col-span-12">
                    <div class="relative">
                        ...
                        <div
                            ...
                            <svg class="w-4 h-4 {{ $errors->first('video_link') ? 'text-red-400' : 'text-gray-400' }}"
