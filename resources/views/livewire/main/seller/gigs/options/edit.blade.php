<div class="w-full">
    ...
    {{-- Header --}}
    <div class="px-4 mx-auto mb-10 max-w-7xl sm:px-6 md:px-12">
        <nav class="justify-between px-4 py-3 text-gray-700 bg-white border border-gray-100 rounded-lg shadow-sm sm:flex sm:px-5 dark:bg-zinc-800 dark:border-zinc-700 dark:shadow-none" aria-label="Breadcrumb">
            ...
            <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 md:rtl:space-x-reverse sm:mb-0">
                ...
                <li>
                    <div class="flex items-center">
                        <a href="{{ url('/') }}" class="text-sm font-medium text-gray-700 ltr:ml-1 rtl:mr-1 hover:text-primary-600 md:ltr:ml-2 md:rtl:mr-2 dark:text-zinc-300 dark:hover:text-white">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <a href="{{ url('seller/gigs') }}" class="text-sm font-medium text-gray-700 ltr:ml-1 rtl:mr-1 hover:text-primary-600 md:ltr:ml-2 md:rtl:mr-2 dark:text-zinc-300 dark:hover:text-white">
            ...
            <div class="flex items-center">
                ...
                <span class="block ltr:mr-3 rtl:ml-4">
                    <a href="{{ url('seller/gigs') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-700/40 rounded shadow-sm text-[13px] font-medium text-gray-700 dark:text-zinc-200 bg-white dark:bg-zinc-700/40 hover:bg-gray-50 dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-primary-600 dark:focus:ring-offset-zinc-700/40">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-500 dark:text-zinc-200 ltr:mr-2 rtl:ml-2 rtl:rotate-180" viewBox="0 0 20 20" fill="currentColor">
                ...
                <span class="block ltr:mr-3 rtl:ml-4">
                    <a href="{{ url('service', $gig->slug) }}" target="_blank" class="inline-flex items-center px-4 py-2 border border-primary-600 rounded shadow-sm text-[13px] font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary-50 focus:ring-primary-600">
                        <svg class="w-4 h-4 text-gray-50 ltr:mr-2 rtl:ml-2 rtl:rotate-180" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 md:px-12">
        {{-- Steps --}}
        <livewire:main.create.steps key="{{ now() }}" :current="$step" />
        {{-- Overview step --}}
        @if ($step === 'overview')
