            ...
            <div class="p-4 mb-4 bg-yellow-100 border-yellow-400 ltr:border-l-4 rtl:border-r-4">
                <div class="flex">
                    <div class="flex-shrink-0">
                        <svg class="w-5 h-5 text-yellow-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"> <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                    </div>
            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate sm:mt-2">
                ...
                <thead>
                    @forelse ($orders as $order)
                        <tr class="h-16 bg-white rounded-md shadow-sm intro-x dark:bg-zinc-800" wire:key="freelancer-dashboard-orders-{{ $order->uid }}">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-52 rtl:text-right">
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    ...
                                    {{-- Thumbnail --}}
                                    <div class="w-10 h-10">
                                        <img class="object-cover w-full h-full rounded-md lazy" src="{{ placeholder_img() }}" data-src="{{ src($order->gig?->thumbnail) }}" alt="{{ $order->gig?->title }}">
                                    </div>
                                                ...
                                                <ol role="list" class="flex items-center space-x-1 rtl:space-x-reverse">
                                                    ...
                                                    <li>
                                                        <div class="flex items-center">
                                                            ...
                                                            {{-- Chevron --}}
                                                            <svg class="flex-shrink-0 w-4 h-4 text-gray-400 rtl:rotate-180" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"> <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/> </svg>

                                                            <a href="{{ url('categories/' . $order->gig->category->slug . '/' . $order->gig->subcategory->slug) }}" target="_blank" class="text-xs font-normal text-gray-500 ltr:ml-1 rtl:mr-1 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100" aria-current="page">{{ $order->gig->subcategory->name }}</a>
                            ...
                            <td class="px-5 py-3 text-center first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md">
                                <div class="flex items-center justify-center space-x-2 rtl:space-x-reverse">
                                    ...
                                    {{-- Order details --}}
                                    <a href="{{ url('seller/orders/details', $order->uid) }}" data-tooltip-target="tooltip-actions-order-details-{{ $order->uid }}" class="inline-flex items-center justify-center w-8 h-8 text-sm font-semibold leading-5 text-gray-800 bg-white border border-gray-300 rounded shadow-sm focus:outline-none hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-700 dark:hover:bg-zinc-900 dark:hover:border-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100" wire:key="tooltip-actions-order-details-{{ $order->uid }}">
                                    ...
                                    {{-- View refund --}}
                                    @if ($order->refund)
                                        <a href="{{ url('seller/refunds/details', $order->refund->uid) }}" data-tooltip-target="tooltip-actions-view-refund-{{ $order->uid }}" class="inline-flex items-center justify-center w-8 h-8 text-sm font-semibold leading-5 text-gray-800 bg-white border border-gray-300 rounded shadow-sm focus:outline-none hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-700 dark:hover:bg-zinc-900 dark:hover:border-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100" wire:key="tooltip-actions-view-refund-{{ $order->uid }}">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="py-3 text-sm font-light tracking-wide text-center text-gray-400 bg-white rounded-md shadow-sm dark:text-zinc-200 dark:bg-zinc-800">
