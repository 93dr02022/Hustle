                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <img class="lazy h-12 w-12 rounded-md object-cover object-center shadow-sm"
                                    src="{{ placeholder_img() }}" data-src="{{ src($order->gig->thumbnail) }}"
                                    alt="">
                            </div>
                ...
                <ol class="relative border-l border-gray-200 dark:border-gray-700">
                    ...
                    @if ($order->finished_at)
                        <li class="mb-10 ml-4">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">The order was completed</h3>
                        </li>
                    @endif
