                    ...
                    @if ($order->status === 'pending')
                        <span class="block ltr:mr-4 rtl:ml-4">
                            <button x-on:click="start" type="button"
                                class="inline-flex items-center px-4 py-2 border border-primary-600 rounded-sm shadow-sm text-[13px] font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary-50 focus:ring-primary-600">
        ...
        <dl class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-gray-200 dark:border-zinc-700 mb-8">
            ...
            <div class="bg-white dark:bg-zinc-600 px-6 py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                ...
                <dd class="mt-1 sm:mt-0 sm:col-span-2">
                    @if ($order->order->invoice && $order->order->invoice->status === 'pending')
                        <span
                            class="inline-flex items-center px-2.5 py-1 rounded-sm text-[13px] font-medium bg-amber-50 text-amber-800 dark:text-amber-400 dark:bg-transparent">
                ...
                <dd class="mt-1 text-sm text-gray-500 dark:text-gray-200 sm:mt-0 sm:col-span-2">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-12 w-12 rounded-md shadow-sm lazy object-cover object-center"
            ...
            @if ($order->has('upgrades'))
                <div class="bg-gray-50 dark:bg-zinc-700/40 px-6 py-5 sm:grid sm:grid-cols-3 sm:gap-4 rounded-b-lg">
                    <dt class="text-sm font-semibold text-black dark:text-gray-400">{{ __('messages.t_upgrades') }}
                    </dt>
                            ...
                            @foreach ($order->upgrades as $upgrade)
                                <div class="relative flex items-start">
                                    <div class="flex items-center h-5">
                                        <input type="checkbox"
                                            class="h-4 w-4 text-gray-300 border-gray-200 border-2 rounded-sm cursor-not-allowed pointer-events-none dark:disabled:bg-zinc-500"
                                            checked disabled>
                                    </div>
                                    <div class="ltr:ml-3 rtl:mr-3 text-sm mt-[-3px]">
                                        <label
                                            class="font-medium text-gray-500 dark:text-gray-200 text-sm">{{ $upgrade->title }}</label>
                                        ...
                                        <div class="mt-1 flex text-sm">
                                            ...
                                            @if ($upgrade->extra_days)
                                                <p
                                                    class="ltr:ml-4 ltr:pl-4 ltr:border-l rtl:mr-4 rtl:pr-4 rtl:border-r border-gray-200 text-gray-400 text-xs">
