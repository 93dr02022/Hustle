                            ...
                            <div
                                ...
                                <div class="grid grid-cols-2 gap-y-2 gap-x-3 sm:gap-x-5 md:grid-cols-3">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="number" placeholder="Price" x-model="form.items[index].price"
                                            @input="sumTotal(index)" class="form-ctr" min="100" max="1000000"
                                            required>
                                    </div>
            ...
            <div x-show="successful" class="max-w-md py-5 mx-auto bg-white rounded shadow-md" x-cloak>
                ...
                <div x-show="form.payment_method == 'paystack'" class="relative mt-7 mx-5">
                    <input class="form-ctr block pl-4 py-4 pr-[75px] read-only:bg-slate-100"
                        :value="`https://correcthustle.com/quotations/${quote.reference}/payment`" readonly />
                    <div class="flex absolute inset-y-0 right-0 items-center pl-4 pr-2 py-3 pointer-events-auto">
                        <button @click="copy(`https://correcthustle.com/quotations/${quote.reference}/payment`)"
                            :class="{ '!bg-green-200': copying }"
