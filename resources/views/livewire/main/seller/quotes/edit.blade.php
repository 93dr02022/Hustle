<div class="w-full">
    ...
    <div class="px-4 mx-auto space-y-2 max-w-7xl sm:px-6 md:px-12">
        <div class="max-w-3xl mx-auto" x-data="window.SellerDashboardEditQuote">
            {{-- notice message --}}
            ...
            @if ($canUpdate)
                <div class="pt-5 mx-auto bg-white rounded shadow-md">
                    <form x-on:submit.prevent="update">
                        ...
                        <div class="flex items-center justify-end px-4 py-3 text-right shadow bg-gray-50 dark:bg-black/50 sm:px-5 sm:rounded-bl-md sm:rounded-br-md">
                            <button type="submit" wire:loading.attr="disabled" wire:target="update" :disabled="total < 10000" class="btn-purple">Proceed</button>
                        </div>
                    </form>
                </div>
            @endif
