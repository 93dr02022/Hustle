        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-5 gap-y-6">
                    ...
                    <fieldset class="mt-4">
                        ...
                        <div class="space-y-5">
                            ...
                            @if (settings('paystack')->is_enabled)
                                <div class="flex items-center">
                                    <input id="selected_payment_method_paystack" name="selected_payment_method" wire:model="selected_payment_method" value="paystack" type="radio"
                                        class="focus:ring-primary-500 h-4 w-4 text-primary-600 border-gray-300 dark:bg-zinc-600 dark:border-zinc-600 dark:focus:ring-zinc-400 dark:focus:ring-offset-zinc-800">
                                    <label for="selected_payment_method_paystack" class="flex items-center ltr:ml-3 rtl:mr-3 cursor-pointer">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                            ...
                            <a href="{{ url('profile', $subscription->bid->user->username) }}" target="_blank" class="block">
                                <img class="rounded-full h-12 w-12 object-cover object-center" src="{{ src($subscription->bid->user->avatar_id) }}" alt="{{ $subscription->bid->user->username }}">
                            </a>
                                ...
                                <div class="flex items-center space-x-3 rtl:space-x-reverse text-[13px] dark:text-zinc-400">
                                    ...
                                    @if ($subscription->bid->user->country)
                                        <p class="flex items-center space-x-1 rtl:space-x-reverse">
                                            <img class="h-4 ltr:pr-0.5 rtl:pl-0.5 -mt-0.5 lazy" src="{{ placeholder_img() }}" data-src="{{ countryFlag($subscription->bid->user->country->code) }}"
                                    ...
                                    <p class="flex shrink-0 items-center space-x-1 rtl:space-x-reverse">
                                        <svg aria-hidden="true" class="w-4 h-4 {{ $subscription->bid->user->rating() == 0 ? 'text-gray-400' : 'text-amber-500' }} -mt-0.5" fill="currentColor"
                    ...
                    @if ($subscription->bid->is_sealed)
                        <div class="flex flex-col items-center justify-between rounded-lg border border-slate-200 px-4 py-3 text-gray-500 sm:flex-row sm:px-5 dark:border-zinc-700 dark:text-zinc-400">
                            ...
                            <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                <svg class="w-5 h-5 text-slate-400 flex-none ltr:-ml-2 rtl:-mr-2" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <aside class="flex items-center mt-3 space-x-5 rtl:space-x-reverse text-xs text-gray-500 dark:text-zinc-300">
                            ...
                            @if ($subscription->bid->is_sponsored)
                                <div class="flex items-center space-x-1 rtl:space-x-reverse">
                                    <svg class="w-4 h-4 text-gray-400" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            <div class="w-full col-span-2">
                ...
                <div class="flex items-center space-x-2 rtl:space-x-reverse justify-center mt-5 text-green-500 dark:text-green-400">
                    <svg class="w-6 h-6" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path
