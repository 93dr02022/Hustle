                    ...
                    <fieldset class="mt-4">
                        ...
                        <div class="space-y-5">
                            ...
                            @if (settings('paypal')->is_enabled)
                                <div class="flex items-center">
                                    <input id="selected_payment_method_paypal" name="selected_payment_method"
                                        wire:model="selected_payment_method" value="paypal" type="radio"
                                    ...
                                    <label for="selected_payment_method_paypal"
                                        class="flex items-center ltr:ml-3 rtl:mr-3 cursor-pointer">
                        ...
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                            ...
                            <a href="{{ url('profile', $subscription->bid->user->username) }}" target="_blank"
                                ...
                                <img class="rounded-full h-12 w-12 object-cover object-center"
                                    src="{{ src($subscription->bid->user->avatar_id) }}"
