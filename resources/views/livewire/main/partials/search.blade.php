<div x-data="window.jDxKFKNiKkfxISD" x-init="init()" x-cloak>
    ...
    {{-- Search button --}}
    <div class="py-2 mx-4 text-gray-400 hover:text-gray-500 dark:text-gray-100 dark:hover:text-white cursor-pointer hidden md:hidden"
        @click="open()">
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto p-4 sm:p-6 md:p-20" role="dialog" aria-modal="true"
        @keydown.window.escape="close()" x-show="isOpen" style="display: none;"
        ...
        <div class="fixed inset-0 bg-gray-500 bg-opacity-25 transition-opacity" aria-hidden="true"
            x-transition:enter="ease-out duration-300"></div>
        ...
        <div class="mx-auto max-w-xl transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black ring-opacity-5 transition-all"
            ...
            <div class="relative">
                ...
                {{-- Icon --}}
                <svg class="pointer-events-none absolute top-3.5 ltr:left-4 rtl:right-4 h-5 w-5 text-gray-400"
                ...
                <div role="status" class="absolute ltr:right-2 rtl:left-2 top-3" wire:loading wire:target="q">
                    <svg class="inline ltr:mr-2 rtl:ml-2 w-6 h-6 text-gray-200 animate-spin fill-primary-600"
            ...
            return {
                ...
                open: function() {
                    ...
                    if (!this.isOpen) {
                        document.activeElement && (this.restoreElement = document.activeElement),
                            (this.search = ""),
                            (document.documentElement.style.paddingRight = "".concat(window.innerWidth - document
                ...
                close: function() {
                    if (this.isOpen) {
                        ...
                        (this.restoreElement = void 0), (document.documentElement.style.overflow = ""), (document
                            .documentElement.style.paddingRight = ""), document.removeEventListener("focusin", this
                            .onFocus, !1);
                        var t,
                            n = this.E(this.w(this.$el));
                        try {
