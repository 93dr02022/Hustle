            ...
            @forelse ($articles as $article)
                <div class="flex flex-col rounded-lg shadow-sm overflow-hidden">
                    <a href="{{ url('blog', $article->slug) }}" class="flex-shrink-0">
                        <img class="h-48 w-full object-cover lazy" src="{{ placeholder_img() }}"
                    ...
                    <div class="flex-1 bg-white dark:bg-zinc-800 p-6 flex flex-col justify-between">
                        <div class="flex-1">
                            ...
                            <a href="{{ url('blog', $article->slug) }}" class="block mt-2 truncate overflow-hidden"
                                style="text-overflow: ellipsis;">
                                <p
                                    class="text-base font-semibold text-gray-900 dark:text-gray-200 hover:text-primary-600 truncate">
                                    {{ $article->title }}</p>
                            </a>
                        </div>
                    </div>
