<div class="w-full">
	...
	{{-- Hero section --}}
	<div class="rounded-xl px-7 pt-2.5 lg:min-h-[530px] md:bg-[120%] xl:bg-[100%] bg-white shadow-sm border border-gray-100 bg-contain bg-no-repeat  relative mx-auto dark:bg-zinc-800 dark:border-transparent lg:bg-[image:var(--projects-image-url)]" style="--projects-image-url: url({{ url('img/explore/projects/1.jpg') }});">
