                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-14 py-6 px-4 sm:p-4">
                            <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100">
                                {{ __('messages.t_refunds') }}</h2>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">
                                {{ __('messages.t_refunds_subtitle') }}</p>
                        </div>
                                ...
                                <thead class="bg-gray-100 dark:bg-zinc-700">
                                    <tr tabindex="0"
                                        ...
                                        <th
                                            ...
                                            {{ __('messages.t_item') }}</th>
                                        <th
                                            class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider ltr:text-left ltr:pl-4 rtl:text-right rtl:pr-4">
                                            {{ __('messages.t_seller') }}</th>
                                        <th
                                ...
                                <tbody class="w-full">
                                    ...
                                    @foreach ($refunds as $refund)
                                        <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40"
                                                ...
                                                <a href="{{ url('service', $refund->item->gig->slug) }}" target="_blank"
                                                    ...
                                                    <div class="w-8 h-8">
                                                        <img class="w-full h-full rounded object-cover lazy"
                                                            src="{{ placeholder_img() }}"
                                                            data-src="{{ src($refund->item->gig->image_thumb_id) }}"
                                                            alt="{{ $refund->item->gig->title }}" />
                                                    </div>
                                                    <div class="ltr:pl-4 rtl:pr-4">
                                                        <p
                                                            class="font-medium text-xs truncate max-w-lg block overflow-hidden dark:text-gray-200">
                                                            {{ $refund->item->gig->title }}</p>
                                                        <p
                                                            class="text-[11px] leading-3 text-gray-600 dark:text-gray-400 pt-2">
                                                            @money($refund->item->gig->price, settings('currency')->code, true)</p>
                                                    </div>
                                                </a>
                                            </td>
                                            ...
                                            {{-- Seller --}}
                                            <td class="ltr:pl-4 rtl:pr-4">
                                                <a href="{{ url('profile', $refund->seller->username) }}"
                                                    target="_blank" class="flex items-center">
                                                    <div class="w-8 h-8">
                                                        <img class="w-full h-full rounded object-cover lazy"
                                                            src="{{ placeholder_img() }}"
                                                            data-src="{{ src($refund->seller->avatar_id) }}"
                                                            alt="{{ $refund->seller->username }}" />
                                                    </div>
                                                    <div class="ltr:pl-4 rtl:pr-4">
                                                        <p
                                                            class="font-medium text-xs truncate max-w-lg block overflow-hidden dark:text-gray-200">
                                                            {{ $refund->seller->username }}</p>
                                                        <p
                                                            class="text-[11px] leading-3 text-gray-600 dark:text-gray-400 pt-2">
                                            ...
                                            <td class="text-center">
                                                @switch($refund->status)
                                                    ...
                                                    @case('closed')
                                                        <span
                                                            class="px-4 py-1 text-xs rounded-2xl font-semibold text-gray-500 bg-gray-50">
                                                    ...
                                                    @case('rejected_by_seller')
                                                        <span
                                                            class="px-4 py-1 text-xs rounded-2xl font-semibold text-red-500 bg-red-50">
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="text-[11px] font-normal text-gray-400 dark:text-gray-200">{{ format_date($refund->created_at, 'ago') }}</span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="relative inline-block text-left">
                                                    <div>
                                                        <a href="{{ url('account/refunds/details', $refund->uid) }}"
                                                            class="inline-flex justify-center items-center rounded-full h-8 w-8 bg-white dark:bg-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-600 focus:outline-none focus:ring-0"
