                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-14 py-6 px-4 sm:p-4">
                            <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100">
                                {{ __('messages.t_reviews') }}</h2>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">
                                {{ __('messages.t_account_reviews_subtitle') }}</p>
                        </div>
                        ...
                        <div
                            class="bg-white dark:bg-zinc-800 overflow-y-auto border !border-t-0 !border-b-0 dark:border-zinc-600">
                                    ...
                                    @foreach ($reviews as $review)
                                        <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40"
                                            ...
                                            <td class="ltr:pl-4 rtl:pr-4">
                                                <a href="{{ url('service', $review->gig->slug) }}" target="_blank"
                                                    ...
                                                    <div class="ltr:pl-4 rtl:pr-4">
                                                        <p
                                                            class="font-medium text-xs truncate max-w-[200px] block overflow-hidden dark:text-gray-100">
                                                            {{ $review->gig->title }}</p>
                                                        <p
                                                            class="text-[11px] leading-3 text-gray-600 dark:text-gray-300 pt-2">
                                                            @money($review->gig->price, settings('currency')->code, true)</p>
                                                    </div>
                                                </a>
                                            </td>
                                            ...
                                            <td class="ltr:pl-4 rtl:pr-4 dark:text-gray-200">
                                                @if ($review->message)
                                                    <span
                                                        class="text-xs font-medium break-words block overflow-hidden max-w-[200px] truncate">{{ $review->message }}</span>
                                                @else
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="text-[11px] font-normal text-gray-400 dark:text-gray-200">{{ format_date($review->created_at, 'ago') }}</span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="relative inline-block text-left">
                                                    <div>
                                                        <button
                                                            data-dropdown-toggle="table-options-dropdown-{{ $review->id }}"
                                                            type="button"
                                                    ...
                                                    <div id="table-options-dropdown-{{ $review->id }}"
                                                        ...
                                                        <div class="py-1" role="none">
                                                            ...
                                                            {{-- Preview review --}}
                                                            <a href="{{ url('account/reviews/preview/' . $review->uid) }}"
                                                                ...
                                                                <span
                                                                    class="text-xs font-medium">{{ __('messages.t_preview_review') }}</span>
                                                            </a>

                                                            {{-- Edit review --}}
                                                            <a href="{{ url('account/reviews/edit/' . $review->uid) }}"
                                                                class="text-gray-800 dark:text-gray-300 group flex items-center px-4 py-2 text-sm"
                                                                role="menuitem" tabindex="-1" id="menu-item-0">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="ltr:mr-3 rtl:ml-3 h-5 w-5 text-gray-400 group-hover:text-gray-500 dark:text-gray-300"
                                                                ...
                                                                <span
                                                                    class="text-xs font-medium">{{ __('messages.t_edit_review') }}</span>
                                                            </a>

                                                            {{-- Delete --}}
                                                            <button
                                                                x-on:click="confirm('{{ __('messages.t_are_u_sure_u_want_to_delete_this_review') }}') ? $wire.delete('{{ $review->id }}') : ''"
                                                                ...
                                                                <span
                                                                    class="text-xs font-medium">{{ __('messages.t_delete_review') }}</span>
