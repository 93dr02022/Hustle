<main class="w-full" x-data="window.AccountBillingInformation">
            ...
            <div
                ...
                <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8 h-[calc(100%-80px)]">
                        ...
                        {{-- billing information --}}
                        <div class="" x-show="tab == 'billing'" x-cloak>
                            {{-- Section header --}}
                            <div class="mb-14">
                            ...
                            <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    <x-forms.text-input label="{{ __('messages.t_city') }}"
                                        placeholder="{{ __('messages.t_enter_city') }}" model="city"
                                        icon="city" />
                                </div>
                                ...
                                <div class="col-span-12" wire:key="billing-address">
                                    <x-forms.textarea label="{{ __('messages.t_address') }}"
                                        placeholder="{{ __('messages.t_enter_address') }}" model="address"
                                        rows="8" icon="map-marker" />
                                </div>
                        ...
                        {{-- payment card information tab --}}
                        <div class="" x-show="tab == 'card'" x-cloak>
...
@push('scripts')
    <script>
        ...
        window.AccountBillingInformation = AccountBillingInformation()
    </script>
@endpush
