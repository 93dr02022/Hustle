                ...
                <div class="mx-auto max-w-7xl">
                    <div class="lg:flex lg:items-center lg:justify-between">
                        ...
                        <div class="mt-5 flex justify-between lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4">
                            ...
                            {{-- View project --}}
                            <span class="block">
                                <a href="{{ url('project/' . $subscription->project->pid . '/' . $subscription->project->slug) }}" target="_blank"
                        ...
                        <fieldset>
                            ...
                            <div class="space-y-5">
                                ...
                                @if (settings('paystack')->is_enabled)
                                    <div class="flex items-center">
                                        <input id="selected_payment_method_paypal" name="selected_payment_method" wire:model="selected_payment_method" value="paystack" type="radio"
                                            class="focus:ring-primary-500 h-5 w-5 text-primary-600 border-gray-300 focus:ring-offset-0 dark:bg-zinc-600 dark:border-transparent">
                                ...
                                @if ($urgent)
                                    <div class="pb-4 flex items-center justify-between">
                                        <dt class="text-gray-600 dark:text-zinc-300">
                                            <span class="font-semibold px-3 py-1 rounded-sm text-[13px] tracking-wide dark:!bg-zinc-500 dark:!text-zinc-200"
