                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-14 py-6 px-4 sm:p-4">
                            <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100">
                                {{ __('messages.t_favorite_list') }}</h2>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">
                                {{ __('messages.t_favorite_list_subtitle') }}</p>
                        </div>
                                    ...
                                    @foreach ($list as $l)
                                        <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40"
                                            ...
                                            <td class="ltr:pl-4 rtl:pr-4">
                                                <a href="{{ url('service', $l->gig->slug) }}" target="_blank"
                                                    class="flex items-center">
                                                    <div class="w-8 h-8">
                                                        <img class="w-full h-full rounded object-cover lazy"
                                                            src="{{ placeholder_img() }}"
                                                            data-src="{{ src($l->gig->image_thumb_id) }}"
                                                            alt="{{ $l->gig->title }}" />
                                                    </div>
                                                    <div class="ltr:pl-4 rtl:pr-4">
                                                        <p
                                                            class="font-medium text-xs truncate max-w-lg block overflow-hidden dark:text-white">
                                                            {{ $l->gig->title }}</p>
                                                        <p
                                                            class="text-[11px] leading-3 text-gray-600 dark:text-gray-300 pt-2">
                                                            @money($l->gig->price, settings('currency')->code, true)</p>
                                                    </div>
                                                </a>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="text-[11px] font-normal text-gray-400 dark:text-gray-200">{{ format_date($l->created_at, 'ago') }}</span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="relative inline-block text-left">
                                                    <div>
                                                        <button
                                                            data-dropdown-toggle="table-options-dropdown-{{ $l->id }}"
                                                            type="button"
                                                    ...
                                                    <div id="table-options-dropdown-{{ $l->id }}"
                                                        ...
                                                        <div class="py-1" role="none">
                                                            ...
                                                            {{-- Delete --}}
                                                            <button
                                                                x-on:click="confirm('{{ __('messages.t_are_u_sure_u_want_to_remove_from_favorite_list') }}') ? $wire.delete('{{ $l->id }}') : ''"
                                                                wire:loading.attr="disabled"
                                                                wire:target="delete('{{ $l->id }}')"
                                                                type="button"
                                                                ...
                                                                <span
                                                                    class="text-xs font-medium">{{ __('messages.t_remove_from_favorite') }}</span>
