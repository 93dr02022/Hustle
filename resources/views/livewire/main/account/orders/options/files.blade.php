                ...
                <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8">
                        ...
                        @if (session()->has('error'))
                            <div
                                class="p-4 relative flex bg-red-50 dark:bg-red-500 text-red-500 dark:text-red-50 text-xs font-semibold rounded-lg mb-4">
                        ...
                        <div class="mb-14 lg:flex lg:items-center lg:justify-between">
                            <div class="flex-1 min-w-0">
                                <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100">
                                    {{ __('messages.t_delivered_work') }}</h2>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">
                                    {{ __('messages.t_download_received_files_from_seller') }}</p>
                            </div>
                            @if (!$item->is_finished && $item->status === 'delivered')
                                <div class="mt-5 flex lg:mt-0 lg:ltr:ml-4 lg:rtl:mr-4">
                                    ...
                                    <span class="ltr:ml-3 rtl:mr-3">
                                        <a href="{{ url('account/orders/request-review', $item->uid) }}"
                                            class="inline-flex items-center px-4 py-2 mr-2 border border-gray-300 dark:border-zinc-600 rounded-sm shadow-sm text-xs font-bold tracking-wide text-gray-700 dark:text-gray-200 bg-white dark:bg-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-offset-2">
                                    ...
                                    @if (!$item->refund)
                                        <span class="block">
                                            <a href="{{ url('account/refunds/request', $item->uid) }}"
                                                class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-600 rounded-sm shadow-sm text-xs font-bold tracking-wide text-gray-700 dark:text-gray-200 bg-white dark:bg-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-offset-2">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="ltr:-ml-1 ltr:mr-2 rtl:-mr-1 rtl:ml-2 h-4 w-4 text-gray-500 dark:text-gray-300"
                                    ...
                                    <span class="ltr:ml-3 rtl:mr-3">
                                        <button
                                            x-on:click='confirm("{{ __('messages.t_are_sure_completed_work_buyer') }}") ? $wire.completed() : "" '
                                            wire:loading.attr="disabled" wire:target="completed" type="button"
                                            ...
                                            {{ __('messages.t_work_completed') }} </button>
                                    </span>
                        ...
                        @if (!$item->is_finished)
                            <div class="flex items-center mb-8 text-blue-500">
                                ...
                                <span
                                    class="text-xs font-medium tracking-wide ltr:ml-2 rtl:mr-2">{{ __('messages.t_order_item_will_mark_done_after_1_week', ['date' => format_date($item->delivered_at, config('carbon-formats.F_j,_Y'))]) }}</span>
                            </div>
                        @endif
                                            ...
                                            <div class="bg-gray-50 dark:bg-zinc-600 px-8 py-4 rounded-t-md">
                                                <div
                                                    ...
                                                    <div class="ltr:ml-4 rtl:mr-4 mt-4">
                                                        <h3
                                                            class="text-sm leading-6 font-semibold tracking-wide text-gray-600 dark:text-gray-100">
                                                            {{ __('messages.t_download_files') }}</h3>
                                                        <p
                                            ...
                                            <div class="px-8 py-5">
                                                ...
                                                @if ($prev_work && $prev_work->is_delivered)
                                                    <div class="border-t pt-3 ">
                                                        <h1
                                                            class="text-base tracking-wide font-bold text-zinc-900 dark:text-gray-100">
                                                        ...
                                                        @if ($prev_work->attached_work)
                                                            <div
                                                                class="flex items-center justify-between space-x-3 mb-6 rtl:space-x-reverse">
                                                                <div
                                                                    class="min-w-0 flex-1 flex items-center space-x-3 rtl:space-x-reverse">
                                                                    <div class="flex-shrink-0">
                                                                        <svg class="w-10" version="1.1"
                                                                            id="Layer_1"
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                    ...
                                                                    <div class="min-w-0 flex-1">
                                                                        <p
                                                                            class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate pb-2">
                                                                            {{ $prev_work->attached_work['id'] }}.{{ $prev_work->attached_work['extension'] }}
                                                                        </p>
                                                                        <p
                                                                            class="text-xs font-[400] text-gray-400 truncate">
                                                        ...
                                                        {{-- Download button --}}
                                                        @if ($prev_work->attached_work)
                                                            <a href="{{ src($prev_work->attached_work['path']) }}"
                                                                target="_blank"
                                                                class="w-full inline-flex items-center justify-center py-3 px-4 border border-transparent rounded-full bg-gray-100 dark:bg-zinc-800 dark:hover:bg-zinc-900 hover:bg-gray-200 focus:outline-none focus:ring-0 mb-6">
                                                                <span
                                                            ...
                                                            <div class="flex flex-col space-y-4 overflow-y-auto">
                                                                <div class="flex items-center">
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            <span
                                                                                class="px-4 py-2 rounded-lg italic inline-block bg-gray-100 dark:bg-zinc-600 text-gray-900 dark:text-gray-200 w-full">
                                                                                {{ $prev_work->quick_response }}
                                                                            </span>
                                                                        </div>
                                                                    </div>
                                                                    <img src="{{ placeholder_img() }}"
                                                                        ...
                                                                        class="w-10 h-10 rounded-full order-1 object-cover lazy">
                                                                </div>
                                                            </div>
                                                        @endif
                                                ...
                                                @if ($delivered_work->review_description)
                                                    <div class="border-t pt-4 mb-4 mt-5">
                                                        <h1
                                                            class="text-base tracking-wide font-bold text-zinc-900 dark:text-gray-100">
                                                            Requested
                                                            Review
                                                        ...
                                                        <p
                                                            class="text-md tracking-wide text-zinc-500 text-justify dark:text-gray-100 mt-2">
                                                            {{ $delivered_work->review_description }}
                                                        </p>
                                                        <div class="flex items-center mt-3 justify-end">
                                                            @if ($delivered_work->is_delivered)
                                                                <span
                                                                    class="px-2 py-1 text-xs text-green-800 bg-green-100 rounded-full">Submitted</span>
                                                            @else
                                                                <span
                                                                    class="px-2 py-1 text-xs text-red-800 bg-red-100 rounded-full">Wait
                                                                    for
                                                                    submission</span>
                                                            @endif
                                                        </div>
                                                ...
                                                @endif
                                                {{-- File details --}}
                                                @if ($delivered_work->attached_work)
                                                    <div
                                                        class="flex items-center justify-between space-x-3 mb-6 rtl:space-x-reverse">
                                                        <div
                                                            class="min-w-0 flex-1 flex items-center space-x-3 rtl:space-x-reverse">
                                                            ...
                                                            <div class="min-w-0 flex-1">
                                                                <p
                                                                    class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate pb-2">
                                                                    {{ $delivered_work->attached_work['id'] }}.{{ $delivered_work->attached_work['extension'] }}
                                                                </p>
                                                                <p class="text-xs font-[400] text-gray-400 truncate">
                                                                    {{ human_filesize($delivered_work->attached_work['size']) }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                {{-- Download button --}}
                                                @if ($delivered_work->attached_work)
                                                    <a href="{{ src($delivered_work->attached_work['path']) }}"
                                                        target="_blank"
                                                        class="w-full inline-flex items-center justify-center py-3 px-4 border border-transparent rounded-full bg-gray-100 dark:bg-zinc-800 dark:hover:bg-zinc-900 hover:bg-gray-200 focus:outline-none focus:ring-0 mb-6">
                                                        <span
                                                            class="text-sm font-medium text-gray-700 dark:text-gray-400">
                                                ...
                                                {{-- Message from seller --}}
                                                @if ($delivered_work->quick_response)
                                                    <div class="flex flex-col space-y-4 overflow-y-auto">
                                                        <div class="flex items-center">
                                                            <div
                                                                class="flex flex-col space-y-2 text-sm ltr:ml-2 rtl:mr-2 order-2 items-center">
