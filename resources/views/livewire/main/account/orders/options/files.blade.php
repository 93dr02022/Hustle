                                            ...
                                            <div
                                                ...
                                                <div class="ltr:ml-4 rtl:mr-4 mt-4 flex-shrink-0">
                                                    <a href="{{ url('account/orders') }}"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="h-4 w-4 text-primary-600 hover:text-primary-600 ltr:mr-2 rtl:ml-2" " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> <path stroke-linecap="round" stroke-linejoin="round" d="M11 17l-5-5m0 0l5-5m-5 5h12"/></svg>
                                    ...
                                    <section class="mb-6">
                                        <div
                                            ...
                                            <div class="px-8 py-5">
                                                ...
                                                {{-- Download button --}}
                                                @if ($item->delivered_work->attached_work)
                                                    <a href="{{ src($item->delivered_work->attached_work['path']) }}"
                                                        target="_blank"
