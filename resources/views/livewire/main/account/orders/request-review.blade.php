                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8">
                        ...
                        <div class="mb-14">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">
                                {{ __('messages.t_request_review_subtitle') }}</p>
                        </div>
                        ...
                        <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                                    ...
                                    <div class="py-6 px-4 sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:p-8">
                                        <div class="sm:flex lg:col-span-7">
                                            <div class="flex-shrink-0 w-full aspect-w-1 aspect-h-1 rounded-lg overflow-hidden sm:aspect-none sm:w-28 sm:h-28">
                                                <img src="{{ placeholder_img() }}" data-src="{{ src($item->gig->image_thumb_id) }}" alt="{{ $item->gig->title }}" class="lazy w-full h-full object-center object-cover sm:w-full sm:h-full">
                                            </div>
                                    ...
                                    <div class="border-t-2 border-dashed border-gray-200 dark:border-zinc-600 py-6 px-4 sm:px-6 lg:p-8">
                                        ...
                                        <div class="mt-6" aria-hidden="true">
                                            ...
                                            <div class="bg-gray-200 dark:bg-zinc-500 rounded-full overflow-hidden">
                                                <div class="h-2 bg-primary-600 rounded-full" style="width: {{ $width }};"></div>
                                            </div>
                                            <div class="hidden sm:grid grid-cols-3 text-sm font-medium text-gray-600 mt-6">
                                                ...
                                                <div class="text-center {{ in_array($item->status, ['proceeded', 'delivered']) ? 'text-primary-600' : '' }}">
                                                    {{ __('messages.t_processing') }}</div>
                                                <div class="ltr:text-right rtl:text-left {{ $item->status === 'delivered' ? 'text-primary-600' : '' }}">
                            ...
                            {{-- Button --}}
                            <div class="col-span-12">
                                <x-forms.button wire:loading.attr="disabled" type="button" action="requestReview" :text="__('messages.t_request_review')" :block="true" />
                            </div>
