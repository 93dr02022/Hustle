                        ...
                        <div class="w-full mb-6">
                            @forelse ($orders as $order)
                                ...
                                @if ($order->quotation == null)
                                    <div class="bg-white dark:bg-zinc-700 border border-gray-200 dark:border-zinc-600 rounded-md mb-10"
                                        wire:key="orders-{{ $order->uid }}">
                                        <div
                                            class="bg-gray-50 dark:bg-zinc-600 border-b sm:rounded-t-md flex items-center p-4 sm:p-6 sm:grid sm:grid-cols-4 sm:gap-x-6 dark:border-zinc-600">

                                            {{-- Order quick stats --}}
                                            <dl
                                                class="flex-1 grid grid-cols-2 gap-x-6 text-sm sm:col-span-3 sm:grid-cols-2 lg:col-span-2">
                                            ...
                                            @foreach ($order->items as $item)
                                                <li class="p-4 sm:p-6">
                                                    <div class="flex items-center sm:items-start">
                                                        ...
                                                        {{-- Gig thumbnail --}}
                                                        <div
                                                            class="flex-shrink-0 w-24 h-24 bg-gray-200 dark:bg-zinc-600 rounded-lg overflow-hidden hidden md:block">
                                                        ...
                                                        <div class="flex-1 ltr:md:ml-6 rtl:md:mr-6 text-sm">
                                                            <div
                                                                ...
                                                                <div>
                                                                    ...
                                                                    {{-- Item title --}}
                                                                    <h1
                                                                        class="text-base font-bold text-gray-900 hover:text-primary-600 mb-2 dark:text-white">
                                                                        ...
                                                                        <span class="flex">
                                                                            <div class="md:text-center">
                                                                                ...
                                                                                @if ($item->refund && $item->refund->status === 'pending')
                                                                                    ...
                                                                                    @elseif
                                                                                    ($item->order->invoice && $item->order->invoice->status === 'pending')
                                                                                    <p
                                                                        ...
                                                                        <ul class="text-sm text-gray-700 dark:text-gray-200"
                                                                            ...
                                                                            <li>
                                                                                <a href="{{ url('messages/new', $item->owner?->username) }}"
                                                                                    ...
                                                                                    <svg class="ltr:mr-3 rtl:ml-3 text-gray-500 w-5 h-5"
                                                                                        stroke="currentColor"
                                                                                        fill="currentColor"
                                                                                        stroke-width="0"
                                                                                        viewBox="0 0 24 24"
                                                                            ...
                                                                            @if (in_array($item->status, ['proceeded', 'delivered']))
                                                                                <li>
                                                                                    <a href="{{ url('account/orders/files?orderId=' . $order->uid . '&itemId=' . $item->uid) }}"
                                                                                        class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700">
                                                                                        <svg class="w-5 h-5 ltr:mr-3 rtl:ml-3 text-gray-500"
                                                                                            stroke="currentColor"
                                                                                            fill="currentColor"
                                                                                            stroke-width="0"
                                                                                            viewBox="0 0 24 24"
                                                                                ...
                                                                                <li>
                                                                                    <button type="button"
                                                                                        ...
                                                                                        <div wire:loading.remove
                                                                                            wire:target="cancel('{{ $item->uid }}')">
                                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                                class="ltr:mr-3 rtl:ml-3 h-5 w-5 text-gray-500 group-hover:text-gray-600"
                                                                                                fill="none"
                                                                                                viewBox="0 0 24 24"
                                                                                                stroke="currentColor"
                                                                                                stroke-width="2">
                                                                            ...
                                                                            @if (
                                                                                ...
                                                                                <li>
                                                                                    <a href="{{ url('account/orders/requirements?order=' . $order->uid . '&item=' . $item->uid) }}"
                                                                                        ...
                                                                                        <svg class="ltr:mr-3 rtl:ml-3 text-gray-500 h-5 w-5"
                                                                                            stroke="currentColor"
                                                                                            fill="currentColor"
                                                                                            stroke-width="0"
                                                                                            viewBox="0 0 24 24"
                                                                        ...
                                                                        @foreach ($item->upgrades as $upgrade)
                                                                            <div class="relative flex items-start">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <label
                                                                                        class="font-medium text-gray-500 dark:text-gray-100 text-xs">
                                                                                        {{ $upgrade->title }}
                                                                                    </label>
                                                                                    <p
                                                        ...
                                                        @if ($item->order->invoice && $item->order->invoice->status === 'paid' && $item->status === 'pending')
                                                            @if (!$item->gig->requirements()->exists() || !$item->is_requirements_sent)
                                                                <div class="flex items-center">
                                                                    ...
                                                                    <p
                                                                        class="ltr:ml-2 rtl:mr-2 text-xs font-medium text-amber-600">
                                                        ...
                                                        <div
                                                            ...
                                                            @if (
                                                                ($item->status === 'pending' || $item->status === 'proceeded') &&
                                                                    ...
                                                                    $item->order->invoice->status === 'paid')
                                                                <div
                                                                    class="flex-1 ltr:pl-4 rtl:pr-4 flex justify-center">
                                                                    <a href="{{ url('account/orders/requirements?order=' . $order->uid . '&item=' . $item->uid) }}"
                                ...
                                @if ($order->quotation !== null)
                                    <div class="bg-white dark:bg-zinc-700 border border-gray-200 dark:border-zinc-600 rounded-md mb-10"
                                        ...
                                        <div role="list"
                                            class="bg-blue-50 divide-y dark:bg-slate-700 divide-gray-200 dark:divide-slate-600 p-4 sm:p-6">
                                            {{-- Item quick stats --}}
                                            <div
                                                class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-x-4 gap-y-4 mb-5">
                                            ...
                                            {{-- Footer actions --}}
                                            <div
                                                class="border-t border-gray-200 pt-4 space-x-4 divide-x divide-gray-200 dark:divide-zinc-600 sm:mt-0 sm:border-none sm:pt-0">
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="ltr:ml-3 rtl:mr-3 flex-1 md:flex md:justify-between">
                                                ...
                                                <p class="mt-3 text-sm md:mt-0 md:ltr:ml-6 md:rtl:mr-6">
                                                    <a href="{{ url('/') }}"
                                                        class="whitespace-nowrap font-medium text-blue-700 hover:text-blue-600">{{ __('messages.t_go_shopping') }}
                                ...
                                @if ($orders->hasPages())
                                    <div
                                        class="bg-white border-t border-b border-gray-200 shadow-sm sm:rounded-lg sm:border px-4 py-5 sm:px-6 flex justify-center">
