                            ...
                            @forelse ($orders as $order)
                                                ...
                                                <li class="p-4 sm:p-6">
                                                    <div class="flex items-center sm:items-start">
                                                        ...
                                                        <div class="flex-shrink-0 w-24 h-24 bg-gray-200 dark:bg-zinc-600 rounded-lg overflow-hidden hidden md:block">
                                                            <img src="{{ placeholder_img() }}" data-src="{{ src($item->gig->image_thumb_id) }}" alt="{{ $item->gig->title }}"
                                                                class="lazy w-full h-full object-center object-cover text-xs">
                                                        </div>
                                                        ...
                                                        <div class="flex-1 ltr:md:ml-6 rtl:md:mr-6 text-sm">
                                                            <div class="md:flex md:items-center md:justify-between md:space-x-4 rtl:space-x-reverse xl:pb-4">
                                                                                ...
                                                                                @else
                                                                                    @switch($item->status)
                                                                                        ...
                                                                                        @case('proceeded')
                                                                                            ...
                                                                                            <div id="orders-{{ $order->uid }}-item-{{ $item->id }}-status-proceeded" role="tooltip"
                                                                                        ...
                                                                                        @case('delivered')
                                                                                            ...
                                                                                            <div id="orders-{{ $order->uid }}-item-{{ $item->id }}-status-delivered" role="tooltip"
                                                                                                class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                                                        ...
                                                                                        @case('canceled')
                                                                                            ...
                                                                                            <div id="orders-{{ $order->uid }}-item-{{ $item->id }}-status-canceled" role="tooltip"
                                                                                                class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                                                        ...
                                                                                        @case('refunded')
                                                                                            ...
                                                                                            <div id="orders-{{ $order->uid }}-item-{{ $item->id }}-status-refunded" role="tooltip"
                                                                                                class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                                ...
                                                                <div class="mt-4 flex space-x-3 md:mt-0">
                                                                    <button type="button" data-dropdown-toggle="orders-{{ $order->uid }}-item-{{ $item->id }}-actions-dropdown"
                                                                        data-dropdown-placement="left-start"
                                                                        class="inline-flex justify-center px-2 py-2 border border-gray-200 dark:border-zinc-700 shadow-sm text-xs font-medium rounded-full text-gray-700 dark:text-gray-300 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-900 focus:outline-none focus:ring-0">
                                                                    ...
                                                                    <div id="orders-{{ $order->uid }}-item-{{ $item->id }}-actions-dropdown"
                                                                        class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-48 dark:bg-zinc-800">
                                                                        <ul class="text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                                                                            ...
                                                                            <li>
                                                                                <a href="{{ url('messages/new', $item->owner?->username) }}" target="_blank"
                                                                                    class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded-t">
                                                                                    <svg class="ltr:mr-3 rtl:ml-3 text-gray-500 w-5 h-5" stroke="currentColor" fill="currentColor" stroke-width="0"
                                                                            ...
                                                                            @if ($item->refund)
                                                                                <li>
                                                                                    <a href="{{ url('account/refunds/details', $item->refund->uid) }}" target="_blank"
                                                                                        ...
                                                                                        <svg class="ltr:mr-3 rtl:ml-3 text-gray-500 w-5 h-5" stroke="currentColor" fill="currentColor"
                                                                            ...
                                                                            @if (in_array($item->status, ['proceeded', 'delivered']))
                                                                                <li>
                                                                                    <a href="{{ url('account/orders/files?orderId=' . $order->uid . '&itemId=' . $item->uid) }}"
                                                                                        class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700">
                                                                                        <svg class="w-5 h-5 ltr:mr-3 rtl:ml-3 text-gray-500" stroke="currentColor" fill="currentColor"
                                                                            ...
                                                                            @if ($item->status === 'pending' && $item->order->invoice && $item->order->invoice->status === 'paid')
                                                                                <li>
                                                                                    <button type="button"
                                                                                        ...
                                                                                        wire:loading.attr="disabled" wire:target="cancel('{{ $item->uid }}')"
                                                                                        class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700 w-full">

                                                                                        {{-- Loading indicator --}}
                                                                                        <div wire:loading wire:target="cancel('{{ $item->uid }}')">
                                                                                            <svg role="status" class="ltr:mr-3 rtl:ml-3 inline w-5 h-5 text-gray-500 animate-spin"
                                                                                        ...
                                                                                        <div wire:loading.remove wire:target="cancel('{{ $item->uid }}')">
                                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                                class="ltr:mr-3 rtl:ml-3 h-5 w-5 text-gray-500 group-hover:text-gray-600" fill="none"
                                                                            ...
                                                                            @if (($item->status === 'pending' || $item->status !== 'proceeded') && $item->order->invoice && $item->order->invoice->status === 'paid')
                                                                                <li>
                                                                                    <a href="{{ url('account/orders/requirements?order=' . $order->uid . '&item=' . $item->uid) }}"
                                                                                        ...
                                                                                        <svg class="ltr:mr-3 rtl:ml-3 text-gray-500 h-5 w-5" stroke="currentColor" fill="currentColor"
                                                                                            stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                                                            <path
                                                                        ...
                                                                        @foreach ($item->upgrades as $upgrade)
                                                                            <div class="relative flex items-start">
                                                                                <div class="flex items-center h-5">
                                                                                    <input type="checkbox"
                                                                                        class="h-4 w-4 text-gray-300 dark:text-gray-400 border-gray-200 dark:border-zinc-600 dark:disabled:bg-zinc-600 border-2 rounded-sm cursor-not-allowed pointer-events-none"
                                                                                        checked disabled>
                                                                                </div>
                                                                                <div class="ltr:ml-3 rtl:mr-3 text-sm mt-[-3px]">
                                                                                    ...
                                                                                    <div class="mt-1 flex text-sm">
                                                                                        ...
                                                                                        @if ($upgrade->extra_days)
                                                                                            <p
                                                                                                class="ltr:ml-4 rtl:mr-4 ltr:pl-4 rtl:pr-4 ltr:border-l rtl:border-r border-gray-200 dark:border-zinc-600 text-gray-400 dark:text-gray-300 text-xs">
                                                    ...
                                                    <div class="mt-6 sm:flex sm:justify-between">
                                                        ...
                                                        {{-- Footer actions --}}
                                                        <div
                                                            class="mt-6 border-t border-gray-200 pt-4 flex items-center space-x-4 divide-x divide-gray-200 dark:divide-zinc-600 rtl:divide-x-reverse text-sm font-medium sm:mt-0 sm:ltr:ml-4 sm:rtl:mr-4 sm:border-none sm:pt-0 rtl:space-x-reverse">
                                ...
                                @if ($order->quotation !== null)
                                    <div class="bg-white dark:bg-zinc-700 border border-gray-200 dark:border-zinc-600 rounded-md mb-10" wire:key="orders-{{ $order->uid }}">
                                        ...
                                        <div role="list" class="bg-blue-50 divide-y dark:bg-slate-700 divide-gray-200 dark:divide-slate-600 p-4 sm:p-6">
                                            {{-- Item quick stats --}}
                                            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-x-4 gap-y-4 mb-5">
                                            ...
                                            {{-- Footer actions --}}
                                            <div class="border-t border-gray-200 pt-4 space-x-4 divide-x divide-gray-200 dark:divide-zinc-600 sm:mt-0 sm:border-none sm:pt-0">
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="ltr:ml-3 rtl:mr-3 flex-1 md:flex md:justify-between">
                                                ...
                                                <p class="mt-3 text-sm md:mt-0 md:ltr:ml-6 md:rtl:mr-6">
                                                    <a href="{{ url('/') }}" class="whitespace-nowrap font-medium text-blue-700 hover:text-blue-600">{{ __('messages.t_go_shopping') }}
