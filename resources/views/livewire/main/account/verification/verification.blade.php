<main class="w-full" x-data="window.nYpPIEgUauhEVLt">
    ...
    <div class="fixed top-0 left-0 z-50 bg-black dark:bg-gray-400/50 w-full h-full opacity-80" wire:loading>
        <div class="w-full h-full flex items-center justify-center">
            <div role="status">
                <svg aria-hidden="true" class="mx-auto w-12 h-12 text-gray-500 dark:text-gray-400 animate-spin fill-white dark:fill-primary-600" viewBox="0 0 100 101" fill="none"
                            ...
                            @if ($currentStep === 1)
                                ...
                                <div class="grid md:grid-cols-2 md:gap-x-8 gap-y-8 mb-6">
                                    ...
                                    <x-forms.text-input label="{{ __('Last name') }}" placeholder="{{ __('Last name') }}" model="last_name" type="tel" icon="at"
                                        class="disabled:bg-slate-300" readonly />
                                </div>
