<div class="w-full" x-data="window.LVoePqYZdmjQURo" x-init="initialize">
    ...
    <div class="py-0 sm:py-10">
        <div class="gap-6 grid grid-cols-1 lg:grid-cols-3 lg:grid-flow-col-dense sm:mt-8">
            ...
            <div class="space-y-10 lg:col-start-1 lg:col-span-2">
                ...
                <section class="w-full">
                    <div class="bg-white dark:bg-zinc-800 shadow-sm rounded-lg border dark:border-transparent">
                        ...
                        {{-- Section heading --}}
                        <div
                            class="py-3.5 px-4 w-full rounded-t-lg flex items-center sm:justify-between bg-gray-50 dark:bg-zinc-700 h-16 space-y-3 sm:space-y-0">
                            <div>
                        ...
                        <div class="border-t border-gray-100 dark:border-zinc-600 px-4 py-5 sm:px-6 pb-8">
                            ...
                            <div
                                class="text-base font-normal leading-relaxed text-zinc-500 dark:text-zinc-200 mb-12 block break-all">
                            ...
                            <div class="mb-12 block">
                                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                    <img class="w-10 h-10 rounded-md lazy object-cover" src="{{ placeholder_img() }}"
                                        data-src="{{ src($project->client->avatar_id) }}" alt="{{ $project->title }}">
                            ...
                            <div class="w-52 h-52 bg-gray-50 rounded-full flex items-center justify-center">
                                <svg class="w-40 h-40 text-zinc-400" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path
                                        ...
                                        transform="translate(-196.27362 -200.00788)" fill="#2f2e41" />
                                    <rect x="226.50312" y="172.03238" width="10.77161" height="2"
                                        fill="#2f2e41" />
                                    <rect x="192.50312" y="172.03238" width="10.77161" height="2"
                                        fill="#2f2e41" />
                                    <path
                                    ...
                                    <rect id="fc777aff-63b1-4720-84dc-e3a9c20790b9"
                                        data-name="ab2e16f2-9798-47da-b25d-769524f3c86f" x="484.20919"
                                        y="242.03206" width="437.1948" height="207.45652"
                                        transform="translate(-238.48792 -95.97299) rotate(-8.21995)" fill="#f1f1f1" />
                                    <rect id="ecffa418-b240-4504-be04-512edea7ccda"
                                        data-name="bf81c03f-68cf-4889-8697-1102f95f97bb" x="496.79745"
                                        y="259.81556" width="412.19197" height="173.08746"
                                        transform="translate(-238.57266 -95.95442) rotate(-8.21995)" fill="#fff" />
                                    <rect id="b49ce3f1-9d75-4481-986b-3b6beb000c79"
                                        data-name="f065dccc-d150-492a-a09f-a7f3f89523f0" x="468.80837"
                                        y="231.16611" width="437.19481" height="18.57334"
                                        transform="translate(-223.58995 -99.25677) rotate(-8.21995)" fill="#e5e5e5" />
                                    <circle id="a4219562-805a-49cd-8b89-b1f92f7a9e75"
                                        data-name="bdbbf39c-df25-4682-8b85-5a6af4a1bd14" cx="288.67474"
                                        cy="71.34324" r="3.4425" fill="#fff" />
                                    <circle id="b0f6399c-6944-4f74-a888-473f61f9730c"
                                        data-name="abcd4292-0b1f-4102-9b5e-e8bbd87baabc" cx="301.6071"
                                        cy="69.47507" r="3.4425" fill="#fff" />
                                    <circle id="b03f93dc-2c99-4323-9b17-02f51b8830c0"
                                        data-name="a3fb731e-8b3d-41ca-96f2-91600dc0b434" cx="314.54005"
                                        cy="67.6068" r="3.4425" fill="#fff" />
                                    <rect id="a6067cfc-0392-4d68-afe4-e34d11a8f0ac"
                                        data-name="ab2e16f2-9798-47da-b25d-769524f3c86f" x="370.25796"
                                        y="100.18309" width="437.1948" height="207.45652" fill="#e6e6e6" />
                                    <rect id="ecd65817-7467-4dbd-a435-c0f1d9841c98"
                                        data-name="bf81c03f-68cf-4889-8697-1102f95f97bb" x="382.75969"
                                        y="117.97286" width="412.19197" height="173.08746" fill="#fff" />
                                    <rect id="eea6c39d-8a45-4eb1-bab9-6120f465de14"
                                        data-name="f065dccc-d150-492a-a09f-a7f3f89523f0" x="370.07154"
                                        y="88.19711" width="437.19481" height="18.57334" fill="#cbcbcb" />
                                    <circle id="ab9e51f9-7431-4d30-8193-f9435a6bd5c3"
                                        data-name="bdbbf39c-df25-4682-8b85-5a6af4a1bd14" cx="383.87383"
                                        cy="99.11864" r="3.4425" fill="#fff" />
                                    <circle id="a54ed687-3b0d-413b-b405-af8897a5c032"
                                        data-name="abcd4292-0b1f-4102-9b5e-e8bbd87baabc" cx="396.94043"
                                        cy="99.11864" r="3.4425" fill="#fff" />
                                    <circle id="fd1d2195-7e97-488f-8f4b-7061a06deb9a"
                                        data-name="a3fb731e-8b3d-41ca-96f2-91600dc0b434" cx="410.00762"
                                        cy="99.11864" r="3.4425" fill="#fff" />
                                    ...
                                    <rect x="620.27691" y="195.75677" width="64.37073" height="4.36332"
                                        fill="#e6e6e6" />
                                    <rect x="593.81776" y="142.916" width="7.10843" height="7.10842"
                                        fill="#e6e6e6" />
                                    <rect x="593.81776" y="155.72527" width="7.10843" height="7.10841"
                                        fill="#e6e6e6" />
                                    <rect x="593.81776" y="167.92442" width="7.10843" height="7.10843"
                                        fill="#e6e6e6" />
                                    <rect x="593.81776" y="181.30967" width="7.10843" height="7.10843"
                                        fill="#e6e6e6" />
                                    <rect x="593.81776" y="194.38423" width="7.10843" height="7.10843"
                                        fill="#e6e6e6" />
                                    ...
                                    <rect x="620.27691" y="260.38129" width="64.37073" height="4.36332"
                                        fill="#e6e6e6" />
                                    <rect x="593.81776" y="207.54051" width="7.10843" height="7.10843"
                                        fill="#e6e6e6" />
                                    <rect x="593.81776" y="220.34979" width="7.10843" height="7.10841"
                                        fill="#e6e6e6" />
                                    <rect x="593.81776" y="232.54894" width="7.10843" height="7.10843"
                                        fill="#e6e6e6" />
                                    <rect x="593.81776" y="245.93419" width="7.10843" height="7.10843"
                                        fill="#e6e6e6" />
                                    <rect x="593.81776" y="259.00875" width="7.10843" height="7.10843"
                                        fill="#e6e6e6" />
                                    <rect x="436.63003" y="243.13905" width="58.05213" height="4.36333"
                                        fill="#e6e6e6" />
                                    <rect x="428.86266" y="254.4769" width="73.05881" height="4.36332"
                                        fill="#e6e6e6" />
                                    <path
            ...
            <section class="lg:col-start-3 lg:col-span-1">
                ...
                {{-- Summary --}}
                <div
                    class="overflow-hidden mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-lg border dark:border-transparent">
                    ...
                    <div class="border-t border-gray-100 dark:border-zinc-600">
                        <dl>
                            ...
                            <div class="bg-white dark:bg-zinc-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500 dark:text-zinc-300">@lang('messages.t_budget')
                                </dt>
                                <dd
                                    class="mt-1 text-sm text-zinc-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
                            ...
                            <div class="bg-gray-50 dark:bg-zinc-600 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500 dark:text-zinc-300">@lang('messages.t_budget_type')
                                </dt>
                                <dd
                                    class="mt-1 text-sm text-zinc-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
                            ...
                            {{-- Total bids --}}
                            <div class="bg-white dark:bg-zinc-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500 dark:text-zinc-300">@lang('messages.t_bids')
                                </dt>
                                <dd
                                    class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
                                    {{ $project->bids_count }}
                                </dd>
                            </div>
                            ...
                            {{-- Avg bid --}}
                            <div class="bg-gray-50 dark:bg-zinc-600 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500 dark:text-zinc-300">@lang('messages.t_avg_bid')
                                </dt>
                                <dd
                                    class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
                            ...
                            {{-- Status --}}
                            <div class="bg-white dark:bg-zinc-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500 dark:text-zinc-300">@lang('messages.t_status')
                                </dt>
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0">
                                    ...
                                    @switch($project->status)
                                        ...
                                        @case('active')
                                            <span
                                                class="bg-emerald-100 text-emerald-600 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
                                        ...
                                        @case('pending_approval')
                                            <span
                                                class="bg-amber-100 text-amber-600 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
                                        ...
                                        @case('completed')
                                            <span
                                                class="bg-green-100 text-green-600 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
                                        ...
                                        @case('hidden')
                                            <span
                                                class="bg-gray-100 text-gray-600 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
                                        ...
                                        @case('rejected')
                                            <span
                                                class="bg-red-100 text-red-600 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
                                        ...
                                        @case('under_development')
                                            <span
                                                class="bg-blue-100 text-blue-600 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
                                        ...
                                        @case('pending_final_review')
                                            <span
                                                class="bg-fuchsia-100 text-fuchsia-600 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
                                        ...
                                        @case('incomplete')
                                            <span
                                                class="bg-stone-100 text-stone-600 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
                                        ...
                                        @case('closed')
                                            <span
                                                class="bg-rose-100 text-rose-600 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
                            ...
                            {{-- Clicks --}}
                            <div class="bg-gray-50 dark:bg-zinc-600 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500 dark:text-zinc-300">@lang('messages.t_clicks')
                                </dt>
                                <dd
                                    class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
                            ...
                            {{-- Impressions --}}
                            <div class="bg-white dark:bg-zinc-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500 dark:text-zinc-300">@lang('messages.t_impressions')
                                </dt>
                                <dd
                                    class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
                            ...
                            {{-- Created date --}}
                            <div class="bg-gray-50 dark:bg-zinc-600 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500 dark:text-zinc-300">@lang('messages.t_posted_date')
                                </dt>
                                <dd
                                    class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
                        ...
                        <div class="grid grid-cols-12 md:gap-x-6 gap-y-6 py-2">
                            ...
                            <div class="col-span-12 md:col-span-6">
                                ...
                                <div class="relative w-full">
                                    ...
                                    {{-- Input --}}
                                    <input wire:model.defer="bid_amount" x-on:keyup="calculateProfit"
                                        x-on:change="verifyAmount" type="text" id="bid-amount-input"
                            ...
                            <div class="col-span-12">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <textarea wire:model.defer="bid_description" id="bid-description-input"
                                        ...
                                        rows="8" placeholder="{{ __('messages.t_describe_ur_proposal_placeholder') }}"></textarea>
                                ...
                                @foreach ($plans as $plan)
                                    <div class="relative flex items-center w-full py-4">
                                        <div class="flex items-center h-5">
                                            <input id="bid-promotion-plan-{{ $plan->uid }}"
                                                name="bidding_selected_plans"
                                                wire:model.defer="bid_{{ $plan->plan_type }}"
                                                value="{{ $plan->uid }}" type="checkbox"
                                        ...
                                        <div class="ltr:ml-4 rtl:mr-4 text-sm w-full">
                                            <label for="bid-promotion-plan-{{ $plan->uid }}"
                                                ...
                                                {{-- Price --}}
                                                <span
                                                    class="text-sm font-semibold text-zinc-700 bg-gray-100 rounded-md px-3 py-2 dark:bg-zinc-900 dark:text-zinc-200">@money($plan->price, settings('currency')->code, true)</span>
    ...
    {{-- Share project --}}
    <x-forms.modal id="modal-share-project-container" target="modal-share-project-button"
    ...
    @auth
        @if (auth()->id() != $project->user_id && auth()->user()->account_type === 'seller')
            <x-forms.modal id="modal-report-project-container" target="modal-report-project-button"
                uid="modal_{{ uid() }}" placement="center-center" size="max-w-xl">
                                    ...
                                    @for ($i = 1; $i <= 6; $i++)
                                        <div class="flex items-center">
                                            <input wire:model.defer="report_reason" value="reason_{{ $i }}"
                                                id="report_project_reason_{{ $i }}" name="report_reason"
                                                type="radio"
        ...
        function LVoePqYZdmjQURo() {
            return {
                    ...
                    if (!isNaN(amount)) {
                        ...
                        if (type === 'fixed') {
                            ...
                            if (value % 1 != 0) {
                                ...
                                // Set value
                                document.getElementById("bid-amount-paid-input").value = (Math.round(value * 100) / 100)
                                    .toFixed(2);
                        ...
                        if (type === 'percentage') {
                            ...
                            if ((amount - value) % 1 != 0) {
                                ...
                                // Set value
                                document.getElementById("bid-amount-paid-input").value = (Math.round((amount - value) *
                                    100) / 100).toFixed(2);
                ...
                verifyAmount(e) {
                    ...
                    // Check value
                    if (Number(amount) < Number('{{ $project->budget_min }}') || Number(amount) > Number(
                            '{{ $project->budget_max }}')) {
