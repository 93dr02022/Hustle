        ...
        <div class="py-16 px-4 sm:py-24 sm:px-6 lg:py-16 lg:px-8 lg:grid lg:grid-cols-12 lg:gap-x-8">
            <div class="lg:col-span-4">
                ...
                <div class="mt-3 flex items-center">
                    ...
                    <p class="ltr:ml-2 rtl:mr-2 text-sm italic text-gray-600 dark:text-gray-200">
                        {{ __('messages.t_based_on_number_reviews', ['number' => $gig->counter_reviews]) }}

                        @if ($rating)
                            <a href="{{ url('reviews', $gig->uid) }}"
                                class="ml-3 not-italic font-medium text-primary-600 text-xs">{{ __('messages.t_reset_filter') }}</a>
                        @endif
                        ...
                        <a href="{{ url('reviews/' . $gig->uid . '?rating=5') }}" class="flex items-center text-sm">
                            ...
                            <dt class="flex-1 flex items-center">
                                ...
                                <div aria-hidden="true" class="ltr:ml-1 rtl:mr-1 flex-1 flex items-center">
                                    <svg class="flex-shrink-0 h-4 w-4 text-amber-400" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="ltr:ml-3 rtl:mr-3 relative flex-1">
                                        ...
                                        @if ($percentage_5)
                                            <div style="width: {{ $percentage_5 }}%"
                                                class="absolute inset-y-0 bg-amber-400 border border-amber-400 rounded-full">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <dd
                                class="ltr:ml-3 rtl:mr-3 w-10 text-right tabular-nums text-xs text-gray-900 font-bold dark:text-gray-400">
            ...
            {{-- Recent reviews --}}
            <div
                class="mt-16 lg:mt-0 lg:col-start-5 lg:col-span-8 bg-white dark:bg-zinc-800 rounded-2xl shadow-sm border border-gray-50 dark:border-zinc-700 h-fit">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ltr:ml-4 rtl:mr-4 group">
                                        ...
                                        <div class="mt-1 flex items-start">
                                            <div class="review-rating-el" data-rating-value="{{ $review->rating }}"
                                                wire:ignore></div>

                                            <span class="ltr:ml-2 rtl:mr-2 text-[11px] font-normal text-gray-400"><span
                                                    class="ltr:pr-2 rtl:pl-2 text-gray-300 dark:text-gray-500">•</span>
