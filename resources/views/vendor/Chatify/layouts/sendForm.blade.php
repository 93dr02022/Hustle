                        ...
                        <ul class="text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                            ...
                            <li>
                                <div @click="openRightModal()"
                                    ...
                                    <span
                                        class="text-xs font-medium text-gray-700 dark:text-gray-300">Quotations</span>
                                    <input type="text" class="hidden" :value="selectedQuote.id"
                                        name="quotation" />
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="flex items-center p-0 rounded hover:bg-gray-100 dark:hover:bg-zinc-700 cursor-pointer"
                                    ...
                                    <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Custom
                                        Offer</span>
                                </div>
                            </li>
        ...
        <x-forms.right-modal x-cloak bodyClass="bg-[#F3F4F6]">
            ...
            <div class="min-h-screen">
                ...
                <template x-for="quote in quotes" :key="quote.id">
                    <div class="border bg-white rounded-md mt-2 mb-5"
                        @click="selectedQuote = quote; hidden = !hidden">
                    ...
                    <form class="!block" @submit.prevent="customMessage">
                        <div
                            ...
                            <div
                                ...
                                <input type="number" class="form-ctr max-w-[100px] !py-2" min="10000"
                                    step="200" placeholder="0.00" x-model="offerForm.offer_amount" required />
                            </div>
                            <div
                                class="flex justify-between items-center py-2 px-3 border-b border-gray-200 dark:border-gray-600 last:border-b-0 p-4">
                                <span class="">Delivery days</span>
                                <input type="number" class="form-ctr max-w-[100px] !py-2" min="1"
                                    max="30" step="1" placeholder="0.00"
                                    x-model="offerForm.delivery_time" required />
                            </div>
                        </div>
